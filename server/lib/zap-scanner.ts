...
import { filterValidZapTechnologies } from './zap-technology-validator';
import {
  selectPlaybook,
  applyPlaybookToZap,
...
export async function startScan(params: {
  ...
  const rawTechnologies = params.discoveredTechnologies || llmConfig.technologies || [];
  const technologies = filterValidZapTechnologies(rawTechnologies);

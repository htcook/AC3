/**
 * Cloud Security Validation Engine
 *
 * Comprehensive CIS Benchmark-aligned misconfiguration testing for AWS, Azure, and GCP.
 * Covers 5 domains per provider: IAM, Networking, Storage, Compute, and Logging/Monitoring.
 * Each check maps to CIS Benchmark controls and MITRE ATT&CK Cloud techniques.
 *
 * @module cloud-security-validation
 */

// ─── Types ─────────────────────────────────────────────────────────

export type CloudProvider = "aws" | "azure" | "gcp";
export type CheckDomain = "iam" | "networking" | "storage" | "compute" | "logging";
export type CheckSeverity = "critical" | "high" | "medium" | "low" | "info";
export type CheckStatus = "pass" | "fail" | "warning" | "error" | "not_assessed";
...
export interface ValidationAssessment {
  ...
  notAssessed: number;
  overallScore: number;
  domainScores: Record<CheckDomain, { passed: number; failed: number; total: number; score: number }>;
  results: CheckResult[];
}

// ─── AWS CIS Benchmark Checks ──────────────────────────────────────

export const AWS_CIS_CHECKS: CISCheck[] = [
  // IAM Domain
  {
    id: "aws-cis-1.1", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.4",
    ...
    severity: "critical", mitreTechniques: ["T1078.004", "T1552.001"],
    ...
    defaultResource: "Root Account", automatable: true,
  },
  {
    id: "aws-cis-1.2", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.5",
    ...
    severity: "critical", mitreTechniques: ["T1078.004"],
    remediationSteps: ["Enable hardware MFA on root account", "Store MFA device in secure location", "Test MFA login flow"],
    defaultResource: "Root Account", automatable: true,
  },
  {
    id: "aws-cis-1.3", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.8",
    ...
    severity: "medium", mitreTechniques: ["T1110"],
    ...
    defaultResource: "Account Password Policy", automatable: true,
  },
  {
    id: "aws-cis-1.4", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.12",
    ...
    severity: "high", mitreTechniques: ["T1078.004", "T1552.001"],
    ...
    defaultResource: "IAM Users", automatable: true,
  },
  {
    id: "aws-cis-1.5", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.16",
    title: "Ensure IAM policies are attached only to groups or roles",
    description: "Attaching policies directly to users makes permission management difficult and error-prone.",
    severity: "medium", mitreTechniques: ["T1078.004"],
    ...
    defaultResource: "IAM Policies", automatable: true,
  },
  {
    id: "aws-cis-1.6", provider: "aws", domain: "iam", cisBenchmark: "CIS AWS 3.0 - 1.17",
    ...
    defaultResource: "IAM Roles", automatable: true,
  },
  // Networking Domain
  {
    id: "aws-cis-2.1", provider: "aws", domain: "networking", cisBenchmark: "CIS AWS 3.0 - 5.1",
    title: "Ensure no security groups allow ingress from 0.0.0.0/0 to port 22",
    description: "Unrestricted SSH access exposes instances to brute-force attacks from the internet.",
    severity: "critical", mitreTechniques: ["T1190", "T1110"],
    ...
    defaultResource: "Security Groups", automatable: true,
  },
  {
    id: "aws-cis-2.2", provider: "aws", domain: "networking", cisBenchmark: "CIS AWS 3.0 - 5.2",
    ...
    severity: "critical", mitreTechniques: ["T1190", "T1110", "T1021.001"],
  ...
  {
    id: "aws-cis-2.3", provider: "aws", domain: "networking", cisBenchmark: "CIS AWS 3.0 - 5.3",
    ...
    severity: "high", mitreTechniques: ["T1190"],
    ...
    defaultResource: "Default Security Group", automatable: true,
  },
  {
    id: "aws-cis-2.4", provider: "aws", domain: "networking", cisBenchmark: "CIS AWS 3.0 - 5.4",
    title: "Ensure VPC flow logging is enabled in all VPCs",
    description: "VPC Flow Logs capture network traffic metadata for security analysis and incident response.",
    severity: "medium", mitreTechniques: ["T1562.008"],
    remediationSteps: ["Enable VPC Flow Logs for all VPCs", "Send logs to CloudWatch Logs or S3", "Set log retention policy"],
    defaultResource: "VPCs", automatable: true,
  },
  // Storage Domain
  {
    id: "aws-cis-3.1", provider: "aws", domain: "storage", cisBenchmark: "CIS AWS 3.0 - 2.1.1",
  ...
  },
  {
    ...
    severity: "high", mitreTechniques: ["T1530"],
    ...
    defaultResource: "EBS Volumes", automatable: true,
  },
  // Compute Domain
  {
    id: "aws-cis-4.1", provider: "aws", domain: "compute", cisBenchmark: "CIS AWS 3.0 - 2.3.1",
    ...
    defaultResource: "RDS Instances", automatable: true,
  },
  {
    id: "aws-cis-4.2", provider: "aws", domain: "compute", cisBenchmark: "CIS AWS 3.0 - 5.6",
    ...
    severity: "high", mitreTechniques: ["T1190", "T1595"],
    ...
    defaultResource: "EC2 Instances", automatable: true,
  },
  {
    id: "aws-cis-4.3", provider: "aws", domain: "compute", cisBenchmark: "CIS AWS 3.0 - 2.3.2",
    ...
    severity: "medium", mitreTechniques: ["T1190"],
  ...
  // Logging Domain
  {
    id: "aws-cis-5.1", provider: "aws", domain: "logging", cisBenchmark: "CIS AWS 3.0 - 3.1",
    ...
    severity: "critical", mitreTechniques: ["T1562.008", "T1070"],
    ...
    defaultResource: "CloudTrail", automatable: true,
  },
  {
    id: "aws-cis-5.2", provider: "aws", domain: "logging", cisBenchmark: "CIS AWS 3.0 - 3.2",
    title: "Ensure CloudTrail log file validation is enabled",
    description: "Log file validation ensures CloudTrail logs have not been tampered with after delivery.",
    severity: "high", mitreTechniques: ["T1070", "T1565"],
    remediationSteps: ["Enable log file validation on all trails", "Monitor for validation failures"],
    defaultResource: "CloudTrail", automatable: true,
  },
  {
    id: "aws-cis-5.3", provider: "aws", domain: "logging", cisBenchmark: "CIS AWS 3.0 - 3.4",
  ...
  {
    id: "aws-cis-5.4", provider: "aws", domain: "logging", cisBenchmark: "CIS AWS 3.0 - 4.3",
    ...
    severity: "high", mitreTechniques: ["T1562.008"],
    remediationSteps: ["Enable GuardDuty in all regions", "Configure findings export to S3", "Integrate with Security Hub"],
    defaultResource: "GuardDuty", automatable: true,
  },
];

// ─── Azure CIS Benchmark Checks ────────────────────────────────────

export const AZURE_CIS_CHECKS: CISCheck[] = [
  // IAM Domain
  {
    id: "azure-cis-1.1", provider: "azure", domain: "iam", cisBenchmark: "CIS Azure 3.0 - 1.1",
    ...
    severity: "critical", mitreTechniques: ["T1078.004", "T1110"],
    ...
    defaultResource: "Entra ID", automatable: true,
  },
  {
    id: "azure-cis-1.2", provider: "azure", domain: "iam", cisBenchmark: "CIS Azure 3.0 - 1.2",
    ...
    defaultResource: "Entra ID Admin Roles", automatable: true,
  },
  {
    id: "azure-cis-1.3", provider: "azure", domain: "iam", cisBenchmark: "CIS Azure 3.0 - 1.5",
    ...
    severity: "high", mitreTechniques: ["T1078.004", "T1199"],
    remediationSteps: ["Enable access reviews for guest users", "Set quarterly review cadence", "Auto-remove guests who fail review"],
    defaultResource: "Entra ID Guest Users", automatable: true,
  },
  {
    id: "azure-cis-1.4", provider: "azure", domain: "iam", cisBenchmark: "CIS Azure 3.0 - 1.11",
    ...
    severity: "high", mitreTechniques: ["T1550.001", "T1098.003"],
    ...
    defaultResource: "Entra ID App Consent", automatable: true,
  },
  // Networking Domain
  {
    id: "azure-cis-2.1", provider: "azure", domain: "networking", cisBenchmark: "CIS Azure 3.0 - 6.1",
    ...
    defaultResource: "Network Security Groups", automatable: true,
  },
  {
    id: "azure-cis-2.2", provider: "azure", domain: "networking", cisBenchmark: "CIS Azure 3.0 - 6.2",
  ...
  {
    id: "azure-cis-2.3", provider: "azure", domain: "networking", cisBenchmark: "CIS Azure 3.0 - 6.5",
    ...
    defaultResource: "Network Watcher", automatable: true,
  },
  // Storage Domain
  {
    id: "azure-cis-3.1", provider: "azure", domain: "storage", cisBenchmark: "CIS Azure 3.0 - 3.1",
    ...
    severity: "high", mitreTechniques: ["T1557", "T1040"],
    ...
    defaultResource: "Storage Accounts", automatable: true,
  },
  {
    id: "azure-cis-3.2", provider: "azure", domain: "storage", cisBenchmark: "CIS Azure 3.0 - 3.2",
  ...
  {
    id: "azure-cis-3.3", provider: "azure", domain: "storage", cisBenchmark: "CIS Azure 3.0 - 3.9",
    ...
    severity: "medium", mitreTechniques: ["T1485", "T1490"],
  ...
  // Compute Domain
  {
    id: "azure-cis-4.1", provider: "azure", domain: "compute", cisBenchmark: "CIS Azure 3.0 - 7.1",
    ...
    severity: "medium", mitreTechniques: ["T1530"],
    remediationSteps: ["Migrate unmanaged disks to managed disks", "Use Azure Disk Encryption for sensitive workloads"],
    defaultResource: "Virtual Machines", automatable: true,
  },
  {
    id: "azure-cis-4.2", provider: "azure", domain: "compute", cisBenchmark: "CIS Azure 3.0 - 7.4",
    ...
    severity: "high", mitreTechniques: ["T1562.001"],
    remediationSteps: ["Enable Defender for Servers Plan 2", "Deploy Log Analytics agent to all VMs", "Configure auto-provisioning"],
    defaultResource: "Defender for Cloud", automatable: true,
  },
  {
    id: "azure-cis-4.3", provider: "azure", domain: "compute", cisBenchmark: "CIS Azure 3.0 - 7.6",
  ...
  // Logging Domain
  {
    id: "azure-cis-5.1", provider: "azure", domain: "logging", cisBenchmark: "CIS Azure 3.0 - 5.1.1",
    ...
    severity: "high", mitreTechniques: ["T1562.008", "T1070"],
    ...
    defaultResource: "Activity Log", automatable: true,
  },
  {
    id: "azure-cis-5.2", provider: "azure", domain: "logging", cisBenchmark: "CIS Azure 3.0 - 5.1.4",
    ...
    severity: "medium", mitreTechniques: ["T1070"],
    remediationSteps: ["Set Activity Log retention to at least 365 days", "Archive to storage account for long-term retention"],
    defaultResource: "Activity Log", automatable: true,
  },
  {
    id: "azure-cis-5.3", provider: "azure", domain: "logging", cisBenchmark: "CIS Azure 3.0 - 5.2.1",
...
// ─── GCP CIS Benchmark Checks ──────────────────────────────────────

export const GCP_CIS_CHECKS: CISCheck[] = [
  // IAM Domain
  {
    id: "gcp-cis-1.1", provider: "gcp", domain: "iam", cisBenchmark: "CIS GCP 3.0 - 1.1",
    ...
    severity: "high", mitreTechniques: ["T1078.004"],
    ...
    defaultResource: "IAM Bindings", automatable: true,
  },
  {
    id: "gcp-cis-1.2", provider: "gcp", domain: "iam", cisBenchmark: "CIS GCP 3.0 - 1.4",
    ...
    defaultResource: "Service Account Keys", automatable: true,
  },
  {
    id: "gcp-cis-1.3", provider: "gcp", domain: "iam", cisBenchmark: "CIS GCP 3.0 - 1.5",
    ...
    severity: "critical", mitreTechniques: ["T1078.004", "T1098"],
    ...
    defaultResource: "Service Accounts", automatable: true,
  },
  {
    id: "gcp-cis-1.4", provider: "gcp", domain: "iam", cisBenchmark: "CIS GCP 3.0 - 1.7",
    ...
    severity: "medium", mitreTechniques: ["T1552.001"],
  ...
  // Networking Domain
  {
    id: "gcp-cis-2.1", provider: "gcp", domain: "networking", cisBenchmark: "CIS GCP 3.0 - 3.6",
    ...
    defaultResource: "Firewall Rules", automatable: true,
  },
  {
    id: "gcp-cis-2.2", provider: "gcp", domain: "networking", cisBenchmark: "CIS GCP 3.0 - 3.7",
  ...
  {
    id: "gcp-cis-2.3", provider: "gcp", domain: "networking", cisBenchmark: "CIS GCP 3.0 - 3.8",
    ...
    defaultResource: "VPC Subnets", automatable: true,
  },
  // Storage Domain
  {
    id: "gcp-cis-3.1", provider: "gcp", domain: "storage", cisBenchmark: "CIS GCP 3.0 - 5.1",
    ...
    defaultResource: "Cloud Storage Buckets", automatable: true,
  },
  {
    id: "gcp-cis-3.2", provider: "gcp", domain: "storage", cisBenchmark: "CIS GCP 3.0 - 5.2",
  ...
  // Compute Domain
  {
    id: "gcp-cis-4.1", provider: "gcp", domain: "compute", cisBenchmark: "CIS GCP 3.0 - 4.1",
    ...
    defaultResource: "Compute Engine", automatable: true,
  },
  {
    id: "gcp-cis-4.2", provider: "gcp", domain: "compute", cisBenchmark: "CIS GCP 3.0 - 4.3",
    ...
    defaultResource: "Compute Instances", automatable: true,
  },
  {
    id: "gcp-cis-4.3", provider: "gcp", domain: "compute", cisBenchmark: "CIS GCP 3.0 - 4.5",
  ...
  // Logging Domain
  {
    ...
    defaultResource: "Cloud Audit Logs", automatable: true,
  },
  {
    id: "gcp-cis-5.2", provider: "gcp", domain: "logging", cisBenchmark: "CIS GCP 3.0 - 2.2",
    ...
    severity: "high", mitreTechniques: ["T1098", "T1078.004"],
    ...
    defaultResource: "Cloud Monitoring", automatable: true,
  },
  {
    id: "gcp-cis-5.3", provider: "gcp", domain: "logging", cisBenchmark: "CIS GCP 3.0 - 2.4",
...
// ─── Aggregated Check Catalog ──────────────────────────────────────

export const ALL_CIS_CHECKS: CISCheck[] = [
  ...AWS_CIS_CHECKS,
  ...AZURE_CIS_CHECKS,
  ...GCP_CIS_CHECKS,
];

export function getChecksByProvider(provider: CloudProvider): CISCheck[] {
  return ALL_CIS_CHECKS.filter(c => c.provider === provider);
}

export function getChecksByDomain(provider: CloudProvider, domain: CheckDomain): CISCheck[] {
  return ALL_CIS_CHECKS.filter(c => c.provider === provider && c.domain === domain);
}

export function getCheckById(id: string): CISCheck | undefined {
...
/**
 * Run a cloud security validation assessment against a provider configuration.
 * In production this would call cloud provider APIs; here it runs deterministic
 * checks against the configuration object and returns structured results.
 */
export function runAssessment(
  ...
  selectedDomains?: CheckDomain[],
): ValidationAssessment {
  const checks = selectedDomains
    ? ALL_CIS_CHECKS.filter(c => c.provider === provider && selectedDomains.includes(c.domain))
    : getChecksByProvider(provider);
  ...
  const domainScores = {} as Record<CheckDomain, { passed: number; failed: number; total: number; score: number }>;
...
/**
 * Evaluate a single CIS check against the provided configuration.
 * Checks the config object for provider-specific settings.
 */
function evaluateCheck(
  check: CISCheck,
  config: Record<string, any>,
): { status: CheckStatus; resourceId: string; currentValue: string; expectedValue: string; evidence: string } {
  const configKey = check.id.replace(/-/g, "_");
  const configValue = config[configKey] ?? config[check.id];

  // If explicit config value provided, use it
  ...
  // No config provided — mark as not assessed
  return {
    status: "not_assessed",
    resourceId: check.defaultResource,
...
/**
 * Generate a compliance summary mapping CIS checks to common frameworks
 */
export function generateComplianceSummary(assessment: ValidationAssessment): {
  frameworks: { name: string; controlsCovered: number; controlsPassing: number; score: number }[];
} {
  const checks = getChecksByProvider(assessment.provider);
  const resultMap = new Map(assessment.results.map(r => [r.checkId, r]));

  // Map CIS checks to common compliance frameworks
...
/**
 * Get provider-specific summary statistics
 */
export function getProviderStats(): {
  providers: { provider: CloudProvider; totalChecks: number; domains: CheckDomain[]; cisBenchmarkVersion: string }[];
} {
  return {
    providers: [

...
import { toolRunnerRouter } from "./routers/tool-runner";
...
import { calderaSeedRouter } from "./routers/caldera-seed";
...
import { competitiveEnginesRouter } from "./routers/competitive-engines";
import { utilityPlaybooksRouter } from "./routers/utility-playbooks";
import { advisoryCorrelationRouter } from "./routers/advisory-correlation";
...
import { actorGenomeRouter } from "./routers/actor-genome";
import { offensiveOpsRouter } from "./routers/offensive-ops";
import { oktaExploitationRouter } from "./routers/okta-exploitation";
...
export const appRouter = router({
  ...
  // Caldera seeding - admin endpoint to enrich from threat catalog
  calderaSeed: calderaSeedRouter,
  ...
  // ─── Competitive Edge Engines (Quick Scan, First Blood, CVE Exploit Gen) ──
  engines: competitiveEnginesRouter,
  // ─── Utility Attack Playbooks (Water, Electric, Sewage) ──
  utilityPlaybooks: utilityPlaybooksRouter,
  // ─── DHS/FBI Advisory Auto-Correlation ──
  advisoryCorrelation: advisoryCorrelationRouter,
  ...
  // ─── Manual Tool Runner & Ingestion Pipeline ────────────────────────────
  toolRunner: toolRunnerRouter,
  ...
  actorGenome: actorGenomeRouter,
  offensiveOps: offensiveOpsRouter,
  oktaExploitation: oktaExploitationRouter,
});

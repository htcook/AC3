    ...
    parties: [
      {
        uuid: generateUUID(),
        type: "organization",
        name: "AC3 Platform — Automated Compliance Engine",
      },
    ],
  };
}
      ...
      "by-components": [
        {
          ...
          uuid: generateUUID(),
          description: `AC3 Module: ${def.ac3Module || "N/A"}`,
  ...
  return {
    "system-security-plan": {
      ...
      "system-characteristics": {
        ...
        "system-name": title,
        description: "FedRAMP KSI Compliance — Generated by AC3",
          ...
          "information-types": [
            {
              ...
              description: "FedRAMP Key Security Indicator compliance data",
      ...
      "control-implementation": {
        description: "FedRAMP KSI Control Implementation",
  ...
  return {
    "assessment-results": {
      ...
      results: [
        {
          uuid: generateUUID(),
          title: "FedRAMP KSI Assessment Results",
          description: "Automated assessment results generated by AC3",
...
function generatePOAM(
  ...
  const poamItems = failingKSIs.map((def, idx) => ({
    ...
    props: [
      ...
      { name: "planned-module", value: def.ac3Module || "TBD" },
    ],
    origins: [
      {
...
export const oscalExportRouter = router({
  ...
  generateAssessmentPackage: protectedProcedure
    .input(z.object({
      title: z.string().default("AC3 FedRAMP Assessment Package"),
      description: z.string().optional(),
    }))
    .mutation(async ({ input, ctx }) => {
      const db = await getDbSafe();
  ...
  getDocumentTypes: protectedProcedure.query(() => {
    return [
      ...
      { id: "component_definition", name: "Component Definition", description: "AC3 component capabilities mapped to KSI requirements" },

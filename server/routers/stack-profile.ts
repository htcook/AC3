...
import { buildProbeSpecs, analyzeProbeResponse, generateProbeReport } from "../lib/scanners/live-probe-engine";
import { detectTechnologies as detectTechnologiesFn } from "../lib/scanners/tech-auto-detector";

/** Normalize a user-provided target: accept bare domains and auto-prepend https:// */
  ...
  detectTechnologies: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      try {
        ...
        const result = detectTechnologiesFn(signals);
        return result;
      } catch (e: any) {
        throw new TRPCError({

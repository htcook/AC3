...
export const domainIntelRouter = router({
    ...
    getConnectorCatalog: publicProcedure
      .query(async () => {
        ...
        const connectorInfo = [
          // Each connector now includes scanMode: which tier it belongs to
          // passive = no target contact, standard = DNS resolution, active = HTTP/TLS contact
          { name: 'shodan-internetdb', description: 'Shodan InternetDB — fast CVE/port lookup (free)', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'passive' as const },
          { name: 'crtsh', description: 'Certificate Transparency logs — subdomain discovery', requiresKey: false, category: 'certificates', free: true, scanMode: 'passive' as const },
          { name: 'shodan', description: 'Shodan — internet-wide device/service scanning', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          { name: 'wayback', description: 'Wayback Machine — historical URL archive', requiresKey: false, category: 'historical', free: true, scanMode: 'passive' as const },
          { name: 'censys', description: 'Censys — host and certificate search', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          { name: 'urlscan', description: 'URLScan.io — URL analysis and screenshots', requiresKey: true, category: 'web', free: false, scanMode: 'passive' as const },
          { name: 'rdap', description: 'RDAP — domain registration data', requiresKey: false, category: 'whois', free: true, scanMode: 'standard' as const },
          { name: 'ripestat', description: 'RIPE Stat — IP/ASN intelligence', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'standard' as const },
          { name: 'securitytrails', description: 'SecurityTrails — DNS history and subdomain enum', requiresKey: true, category: 'dns', free: false, scanMode: 'passive' as const },
          { name: 'dehashed', description: 'DeHashed — credential breach search', requiresKey: true, category: 'breaches', free: false, scanMode: 'passive' as const },
          { name: 'binaryedge', description: 'BinaryEdge — internet scanning and threat intel', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          { name: 'greynoise', description: 'GreyNoise — IP noise/threat classification', requiresKey: true, category: 'threat-intel', free: false, scanMode: 'passive' as const },
          { name: 'email-security', description: 'Email security — DMARC/SPF/DKIM analysis', requiresKey: false, category: 'email', free: true, scanMode: 'standard' as const },
          { name: 'http-security', description: 'HTTP security — headers and WAF detection', requiresKey: false, category: 'web', free: true, scanMode: 'active' as const },
          { name: 'cloud-assets', description: 'Cloud assets — S3/Azure/GCP bucket enumeration', requiresKey: false, category: 'cloud', free: true, scanMode: 'passive' as const },
          { name: 'dns-deep', description: 'Deep DNS — comprehensive record analysis', requiresKey: false, category: 'dns', free: true, scanMode: 'standard' as const },
          { name: 'github-leaks', description: 'GitHub — code leak and secret scanning', requiresKey: false, category: 'code', free: true, scanMode: 'passive' as const },
          { name: 'virustotal', description: 'VirusTotal — malware/URL/domain reputation', requiresKey: true, category: 'threat-intel', free: false, scanMode: 'passive' as const },
          { name: 'hibp', description: 'Have I Been Pwned — breach exposure lookup', requiresKey: true, category: 'breaches', free: false, scanMode: 'passive' as const },
          { name: 'whoisxml', description: 'WhoisXML — WHOIS records and subdomain enum', requiresKey: true, category: 'whois', free: false, scanMode: 'passive' as const },
          { name: 'leakix', description: 'LeakIX — exposed services and data leaks', requiresKey: true, category: 'leaks', free: false, scanMode: 'passive' as const },
          { name: 'fullhunt', description: 'FullHunt — attack surface discovery', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          { name: 'netlas', description: 'Netlas.io — internet-wide host scanning', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          { name: 'hunter', description: 'Hunter.io — email discovery and verification', requiresKey: true, category: 'email', free: false, scanMode: 'passive' as const },
          { name: 'social-media', description: 'Social media — GitHub org/user presence', requiresKey: false, category: 'social', free: true, scanMode: 'passive' as const },
          { name: 'abuseipdb', description: 'AbuseIPDB — IP abuse reputation scoring', requiresKey: true, category: 'threat-intel', free: false, scanMode: 'passive' as const },
          { name: 'passivetotal', description: 'PassiveTotal — passive DNS and SSL history', requiresKey: true, category: 'dns', free: false, scanMode: 'passive' as const },
          { name: 'intelx', description: 'IntelX — darkweb/paste site search for domain mentions', requiresKey: true, category: 'darkweb', free: false, scanMode: 'passive' as const },
          { name: 'hudson-rock', description: 'Hudson Rock — stealer log credential exposure', requiresKey: true, category: 'darkweb', free: false, scanMode: 'passive' as const },
          { name: 'leakcheck', description: 'LeakCheck — credential leak database search', requiresKey: true, category: 'breaches', free: false, scanMode: 'passive' as const },
          { name: 'company-intel', description: 'Company Intel — LLM-powered firmographic data extraction', requiresKey: false, category: 'business-intel', free: true, scanMode: 'passive' as const },
          { name: 'threatminer', description: 'ThreatMiner — domain/IP threat intel and APT reports', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'ip-api', description: 'IP-API — IP geolocation, ASN, and org info', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'passive' as const },
          { name: 'bgpview', description: 'BGPView — ASN lookup, network peers, IP prefixes', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'passive' as const },
          { name: 'ransomware-live', description: 'Ransomware.live — ransomware victim tracking', requiresKey: false, category: 'darkweb', free: true, scanMode: 'passive' as const },
          { name: 'threatfox', description: 'ThreatFox/abuse.ch — IOC database with domain correlation', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'builtwith', description: 'BuiltWith — technology stack detection (CMS, frameworks)', requiresKey: false, category: 'web', free: true, scanMode: 'passive' as const },
          { name: 'circl-pdns', description: 'CIRCL PassiveDNS — historical DNS resolution data', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          { name: 'commoncrawl', description: 'CommonCrawl — historical web data for company context', requiresKey: false, category: 'historical', free: true, scanMode: 'passive' as const },
          { name: 'reverse-whois', description: 'Reverse WHOIS — discover all domains owned by target org', requiresKey: false, category: 'whois', free: true, scanMode: 'passive' as const },
          { name: 'typosquat', description: 'Typosquat — detect lookalike/phishing domains', requiresKey: false, category: 'phishing', free: true, scanMode: 'standard' as const },
          // Domain Health (MXToolbox-equivalent)
          { name: 'domain-health', description: 'Domain Health — DNSBL blacklist, SMTP test, PTR, DNS health, IP block, TCP connectivity', requiresKey: false, category: 'dns', free: true, scanMode: 'standard' as const },
          // Threat Intel Expansion
          { name: 'alienvault-otx', description: 'AlienVault OTX — threat intel exchange, pulses, passive DNS, malware', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'google-safe-browsing', description: 'Google Safe Browsing — malware, phishing, unwanted software detection', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'phishtank', description: 'PhishTank — community-verified phishing URL database', requiresKey: false, category: 'phishing', free: true, scanMode: 'passive' as const },
          // Dark Web Cross-Reference
          { name: 'darkweb-crossref', description: 'Dark Web Cross-Reference — ransomware, IAB, data leak intel from underground DB', requiresKey: false, category: 'darkweb', free: true, scanMode: 'passive' as const },
          // Dehashed WHOIS
          { name: 'dehashed-whois', description: 'Dehashed WHOIS — registration data, reverse WHOIS, subdomain scan', requiresKey: true, category: 'whois', free: false, scanMode: 'passive' as const },
          // Free Subdomain Enumeration
          { name: 'anubis', description: 'Anubis — free subdomain enum via CT + DNS aggregation', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          { name: 'hackertarget', description: 'HackerTarget — free host search (100 queries/day)', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          { name: 'rapiddns', description: 'RapidDNS — free subdomain enum from DNS zone files', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          { name: 'dnsrepo', description: 'DNSRepo — free subdomain enum from DNS zone file database', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          { name: 'sitedossier', description: 'Sitedossier — free subdomain enum from web crawl database', requiresKey: false, category: 'dns', free: true, scanMode: 'passive' as const },
          // Infrastructure Discovery
          { name: 'favicon-hash', description: 'Favicon Hash — MMH3 hash for Shodan infrastructure discovery', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'active' as const },
          { name: 'jarm-fingerprint', description: 'JARM — TLS fingerprinting to detect C2, CDN, server software', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'active' as const },
          // DNS Security
          { name: 'dns-zone-transfer', description: 'DNS Zone Transfer — AXFR attempt against nameservers', requiresKey: false, category: 'dns', free: true, scanMode: 'active' as const },
          // Historical Analysis
          { name: 'wayback-diff', description: 'Wayback Diff — historical content analysis for removed admin panels, leaked creds', requiresKey: false, category: 'historical', free: true, scanMode: 'passive' as const },
          // Enhanced Recon Modules
          { name: 'container-discovery', description: 'Container Discovery — Docker, Kubernetes, registry infrastructure detection', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'active' as const },
          { name: 'github-recon', description: 'Enhanced GitHub Recon — org discovery, repo enum, CI/CD, secrets, dorks', requiresKey: false, category: 'code', free: true, scanMode: 'standard' as const },
          { name: 'cloud-bucket-recon', description: 'Enhanced Cloud Bucket Recon — 5 providers, permission depth, sensitive files', requiresKey: false, category: 'cloud', free: true, scanMode: 'active' as const },
          { name: 'coalition-control', description: 'Coalition Control ASM — internet scanning and threat intel (replaces BinaryEdge)', requiresKey: true, category: 'infrastructure', free: false, scanMode: 'passive' as const },
          // Tier 1 OSINT Gap Connectors (Apr 2026)
          { name: 'urlhaus', description: 'URLhaus (abuse.ch) — malicious URL hosting detection', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'malwarebazaar', description: 'MalwareBazaar (abuse.ch) — malware distribution association', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'sec-edgar', description: 'SEC EDGAR — US public company 10-K filings for BIA financial context', requiresKey: false, category: 'business-intel', free: true, scanMode: 'passive' as const },
          { name: 'osv-dev', description: 'OSV.dev — open source vulnerability database (npm/PyPI/Go supply chain)', requiresKey: false, category: 'vulnerability', free: true, scanMode: 'passive' as const },
          { name: 'team-cymru', description: 'Team Cymru — authoritative IP-to-ASN mapping via DNS', requiresKey: false, category: 'infrastructure', free: true, scanMode: 'standard' as const },
          { name: 'cisa-advisories', description: 'CISA Advisories — KEV catalog and ICS vulnerability advisories', requiresKey: false, category: 'vulnerability', free: true, scanMode: 'passive' as const },
          // Tier 2 OSINT Gap Connectors (Apr 2026)
          { name: 'feodo-tracker', description: 'Feodo Tracker (abuse.ch) — botnet C2 infrastructure tracking', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'standard' as const },
          { name: 'sslbl', description: 'SSLBL (abuse.ch) — SSL certificate blacklist for C2/malware', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
          { name: 'github-advisories', description: 'GitHub Security Advisories — GHSA vulnerability database', requiresKey: false, category: 'vulnerability', free: true, scanMode: 'passive' as const },
          { name: 'certspotter', description: 'Certspotter (SSLMate) — CT log monitoring and subdomain discovery', requiresKey: false, category: 'certificates', free: true, scanMode: 'passive' as const },
          { name: 'companies-house', description: 'Companies House (UK) — corporate registry for BIA context', requiresKey: false, category: 'business-intel', free: true, scanMode: 'passive' as const },
          { name: 'opencorporates', description: 'OpenCorporates — global corporate registry (140M+ companies)', requiresKey: false, category: 'business-intel', free: true, scanMode: 'passive' as const },
          { name: 'hc3', description: 'HC3 (HHS) — healthcare sector cybersecurity threat intelligence', requiresKey: false, category: 'threat-intel', free: true, scanMode: 'passive' as const },
        ];

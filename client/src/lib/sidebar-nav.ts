...
export const sidebarNavGroups: NavGroup[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Custom Exploits", path: "/custom-exploits", icon: Code2, roles: ["admin", "operator", "team_lead"] },
      { label: "Exploit Knowledge", path: "/exploit-knowledge", icon: BookOpen },
      { label: "Exploit Learning", path: "/exploit-learning", icon: GraduationCap },
      { label: "Credential Attacks", path: "/credential-attacks", icon: Key, roles: ["admin", "operator", "team_lead"] },
    ],
  },
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Google Dorking", path: "/google-dorking", icon: Search },
      ...
      { label: "Supply Chain Intel", path: "/supply-chain-intel", icon: Package },
      { label: "ICS Intelligence", path: "/ics-intelligence", icon: Factory },
      { label: "Zero-Day Tracker", path: "/zero-day-tracker", icon: AlertTriangle },
      { label: "Conflict Theater", path: "/conflict-theater", icon: Globe },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "ScanForge Dashboard", path: "/scanforge-dashboard", icon: Gauge },
      { label: "DAST Scanners", path: "/dast-scanners", icon: Scan },
      { label: "Commercial Scanners", path: "/commercial-scanners", icon: Scan },
      { label: "DNS Security", path: "/dns-security", icon: Globe },
      { label: "Tool Comparison", path: "/tool-comparison", icon: BarChart3 },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Credential Auto-Rotation", path: "/credential-auto-rotation", icon: Key, roles: ["admin", "team_lead"] },
      { label: "Packet Analysis", path: "/packet-analysis", icon: Network, roles: ["admin", "operator", "team_lead"] },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "AC3 Reports", path: "/ac3-reports", icon: FileText },
      { label: "Evidence Integrity", path: "/evidence-integrity", icon: FileCheck2 },
      { label: "RoE Self-Service", path: "/roe-self-service", icon: ScrollText },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "Pipeline Dashboard", path: "/pipeline-dashboard", icon: Activity, roles: ["admin", "team_lead"] },

...
const AttackTemplates = lazyWithRetry(() => import("./pages/AttackTemplates"));
...
const GoogleDorking = lazyWithRetry(() => import("./pages/GoogleDorking"));
...
const ExploitGuardrails = lazyWithRetry(() => import("./pages/ExploitGuardrails"));
...
const SubmissionPrep = lazyWithRetry(() => import("./pages/SubmissionPrep"));
...
const SupplyChainIntel = lazyWithRetry(() => import("./pages/SupplyChainIntel"));
const ArsenalDashboard = lazyWithRetry(() => import("./pages/ArsenalDashboard"));
const OktaExploitation = lazyWithRetry(() => import("./pages/OktaExploitation"));
const UtilityPlaybooks = lazyWithRetry(() => import("./pages/UtilityPlaybooks"));
const AdvisoryCorrelation = lazyWithRetry(() => import("./pages/AdvisoryCorrelation"));
const AttackSurfaceAnalysis = lazyWithRetry(() => import("./pages/AttackSurfaceAnalysis"));
const ActorGenome = lazyWithRetry(() => import("./pages/ActorGenome"));
const OffensiveOps = lazyWithRetry(() => import("./pages/OffensiveOps"));
  ...
  const routeContent = (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/attack-templates">
          <ProtectedRoute component={AttackTemplates} />
        </Route>
        ...
        <Route path="/attack-surface-analysis">
          <ProtectedRoute component={AttackSurfaceAnalysis} />
        </Route>
        ...
        <Route path="/google-dorking">
          <ProtectedRoute component={GoogleDorking} />
        </Route>
        ...
        <Route path="/exploit-guardrails">
          <ProtectedRoute component={ExploitGuardrails} />
        </Route>
        ...
        <Route path="/submission-prep">
          <ProtectedRoute component={SubmissionPrep} />
        </Route>
        ...
        <Route path="/arsenal-dashboard">
          <ProtectedRoute component={ArsenalDashboard} />
        </Route>
        <Route path="/okta-exploitation">
          <ProtectedRoute component={OktaExploitation} />
        </Route>
        <Route path="/utility-playbooks">
          <ProtectedRoute component={UtilityPlaybooks} />
        </Route>
        <Route path="/advisory-correlation">
          <ProtectedRoute component={AdvisoryCorrelation} />
        </Route>
        <Route path="/actor-genome">
          <ProtectedRoute component={ActorGenome} />
        </Route>
        <Route path="/offensive-ops">
          <ProtectedRoute component={OffensiveOps} />
        </Route>
        ...
        <Route path="/supply-chain-intel">
          <ProtectedRoute component={SupplyChainIntel} />
        </Route>
        ...
        <Route path="/api-health">
          <ProtectedRoute component={ApiHealthDashboard} pageName="ApiHealthDashboard" />
        </Route>

...
export default function AdversaryDetail() {
  ...
  return (
    <AppShell activePath="/adversaries">
{/* Sidebar */}
<header className="sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b border-border">
          <div className="px-6 py-4">
            ...
            {isLoading ? (
              ...
              <h1 className="font-display text-3xl md:text-2xl sm:text-3xl lg:text-4xl text-destructive">ERROR LOADING ADVERSARY</h1>
            ) : (
              <h1 className="font-display text-3xl md:text-2xl sm:text-3xl lg:text-4xl text-primary">{adversary?.name || 'Unknown Adversary'}</h1>
            )}
          </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <Button 
                    ...
                    onClick={() => window.open('/emulation', '_self')}
                  >
            ...
            {adversaryAbilities.length > 0 && (
              <section>
                ...
                <div className="bg-card border-2 border-border p-6 overflow-x-auto">
                  <div className="grid grid-cols-2 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:grid-cols-7 gap-3">

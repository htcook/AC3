...
export default function EvidencePlus() {
  return (
    <div className="space-y-6 max-w-6xl">
      <div className="border-b border-gray-800 pb-4">
        ...
        <h2 className="text-2xl font-bold tracking-wider text-gray-100">AC3-Plus Evidence Management</h2>
        <p className="text-gray-400 mt-2 text-sm max-w-3xl">
          Upload, organize, and link evidence artifacts to controls. Maintains cryptographic integrity chain for audit trail verification.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FeatureCard title="Drag-and-Drop Upload" />
            <FeatureCard title="Control Linking" />
            <FeatureCard title="Integrity Chain (SHA-256)" />
            <FeatureCard title="Artifact Tagging" />

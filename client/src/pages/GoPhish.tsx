        ...
        <header className="sticky top-0 z-30 bg-card/80 backdrop-blur-sm border-b border-border px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <a href="/phishing" target="_blank" rel="noopener noreferrer">
  ...
  return (
    <div className="bg-card border-2 border-border hover:border-orange-500 p-4 transition-colors">
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        ...
        <a href={`/phishing/campaigns/${campaign.id}`} target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-400 font-display tracking-wider flex items-center gap-1">

...
export default function NarrativesPlus() {
  return (
    <div className="space-y-6 max-w-6xl">
      <div className="border-b border-gray-800 pb-4">
        ...
        <h2 className="text-2xl font-bold tracking-wider text-gray-100">AC3-Plus Narrative Generator</h2>
        <p className="text-gray-400 mt-2 text-sm max-w-3xl">
          AI-powered implementation narrative generation for SSP control descriptions. Uses Amazon Bedrock (Claude) to produce FedRAMP-compliant narratives based on your system architecture.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FeatureCard title="Single Control Generation" />
            <FeatureCard title="Bulk Generation" />
            <FeatureCard title="Inline Editing" />
            <FeatureCard title="Version History" />
            <FeatureCard title="Compliance Review Workflow" />
      </div>

...
const RECENT_UPDATES = [
  { date: "Feb 2026", title: "Metasploit Auto-Provisioning", desc: "One-click DigitalOcean droplet provisioning for Metasploit Framework. Auto-configures MSGRPC, deploys Caldera agent stagers, and manages the full exploit-to-agent pipeline." },
  { date: "Feb 2026", title: "Unified Exploit Catalog", desc: "Merged phishing exploits and CVE exploits into a single catalog with Caldera ability metadata. One-click sync to Caldera as abilities for both initial-access and post-exploitation." },
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "Confirmed vulnerabilities are automatically matched to real exploit code from a library of 4,370+ modules. You see exactly which weaknesses have working attacks available."
                },
                {
                  step: "3",
                  icon: Crosshair,
      ...
      <section className="py-16 bg-card/50">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <AnimatedStat value={50} label="INTEGRATED MODULES" suffix="+" />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <PillarCard
              ...
              description="Match confirmed vulnerabilities to 4,370+ Metasploit modules and ExploitDB entries, deploy them as Caldera abilities, and execute real attack chains using APT adversary profiles."
              features={[
            ...
            <PillarCard
              ...
              description="Shodan-verified domain intelligence with 3-tier evidence corroboration. Active DNS resolution, HTTP header parsing, and banner confirmation separate real risks from noise."
              features={[
            ...
            <PillarCard
              ...
              description="492+ threat actor profiles with kill chain visualization, exploit cross-referencing, and one-click campaign deployment. Five vulnerability feeds with Shodan verification."
              features={[
          ...
          <div className="space-y-12">
            <ModuleSection
              ...
              modules={[
                ...
                { icon: Target, name: "Adversaries", desc: "Caldera adversary profiles with APT-based creation" },
            ...
            <ModuleSection
              ...
              color="text-red-400"
              modules={[
                { icon: Zap, name: "Phishing Ops", desc: "Exploit-enhanced GoPhish campaigns with 15 advanced techniques" },
            ...
            <ModuleSection
              ...
              modules={[
                { icon: Bug, name: "Exploit Arsenal", desc: "Unified catalog: 4,370+ Metasploit modules + ExploitDB + phishing exploits" },
                ...
                { icon: Shield, name: "Threat Actors", desc: "492+ actor profiles with kill chains and campaign deployment" },
            ...
            <ModuleSection
              ...
              modules={[
                ...
                { icon: Scan, name: "Shodan Verification", desc: "Real-time banner verification confirms CVEs on live assets" },

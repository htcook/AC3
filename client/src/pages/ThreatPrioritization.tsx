  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <div className="border-b border-gray-800 pb-4">
        ...
        <h2 className="text-2xl font-bold tracking-wider text-gray-100">AC3-Plus Threat Prioritization</h2>
        <p className="text-gray-400 mt-2 text-sm max-w-3xl">
          Weight compliance controls by active threat relevance using AC3 threat intelligence feeds. Prioritize remediation based on real-world attack patterns targeting your stack.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FeatureCard title="AC3 Threat Feed Integration" />
            <FeatureCard title="Control-to-Threat Mapping" />
            <FeatureCard title="Priority Scoring" />
            <FeatureCard title="Stack-Aware Recommendations" />
            <FeatureCard title="MITRE ATT&CK Correlation" />
      </div>

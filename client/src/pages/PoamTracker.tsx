  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <div className="border-b border-gray-800 pb-4">
        ...
        <h2 className="text-2xl font-bold tracking-wider text-gray-100">AC3-Plus POA&M Tracker</h2>
        <p className="text-gray-400 mt-2 text-sm max-w-3xl">
          Plan of Action and Milestones management. Track findings, assign remediation owners, set deadlines, and monitor closure status for FedRAMP continuous monitoring.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FeatureCard title="Finding Import" />
            <FeatureCard title="Owner Assignment" />
            <FeatureCard title="Milestone Tracking" />
            <FeatureCard title="Status Dashboard" />
            <FeatureCard title="Overdue Alerts" />
      </div>

...
const WORKFLOWS: WorkflowDefinition[] = [
  {
    ...
    steps: [
      ...
      { id: "domain-intel", title: "Run Domain Recon", description: "Discover the target's attack surface with 27 passive recon connectors", href: "/domain-intel", icon: Search, tip: "Enter the primary domain — the pipeline runs Shodan, Censys, SecurityTrails, and 24 other sources automatically" },

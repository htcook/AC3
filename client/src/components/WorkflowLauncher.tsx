...
const WORKFLOWS: WorkflowDefinition[] = [
  {
    ...
    steps: [
      ...
      { id: "scoring", title: "Review Risk Scoring", description: "Analyze CARVER+Shock scores and prioritize targets", href: "/scoring", icon: Crosshair, tip: "Focus on assets with high mission impact and low defensive posture" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "bia", title: "Generate BIA Report", description: "Auto-generate Business Impact Analysis from scan data", href: "/bia-report", icon: BarChart3, tip: "Uses CARVER+Shock scores to quantify business impact" },

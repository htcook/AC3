...
const KSI_THEMES: KSITheme[] = [
  {
    ...
    agencyValue: "Agencies can review CSP penetration test evidence generated by ACE C3, including exploit proof artifacts, DAST scan results, and vulnerability remediation timelines. The Validation Engine confirms whether reported vulnerabilities are actually exploitable, giving agencies confidence in CSP security posture beyond self-reported scan results.",
    ksis: [
      {
        ...
        agencyDetail: "Review CSP vulnerability scan results from Domain Intel and DAST Scanner. Validation Engine evidence proves whether vulnerabilities are actually exploitable — not just theoretical. Track remediation SLA compliance through Evidence Chain timestamps."
      },
      {
        ...
        agencyDetail: "Agencies receive Post-Engagement Reports with clickable evidence artifacts proving each finding. Reports include MITRE ATT&CK heatmaps showing which techniques were tested, exploit proof screenshots, and remediation recommendations with severity ratings."
      },
      {
        ...
        agencyDetail: "Verify CSP maintains continuous validation through scheduled assessment evidence. Agentless BAS results show detection coverage percentages. ATT&CK Validation test results demonstrate which techniques the CSP can detect and which remain blind spots."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can consume OSCAL exports from CSPs using ACE C3 to verify assessment data in machine-readable format. Evidence Chain provides tamper-resistant audit trails of all validation activities, enabling agencies to verify CSP assessment cadence and completeness.",
    ksis: [
      {
        ...
        agencyDetail: "Consume OSCAL-formatted authorization packages exported by CSPs. Evidence Chain records provide an immutable audit trail of when assessments were performed, what was tested, and what evidence was captured."
      },
      {
        ...
        agencyDetail: "Review CSP ongoing assessment reports with embedded evidence links. Reports include validation coverage percentages, MITRE ATT&CK technique coverage, and clickable links to proof artifacts stored in Evidence Chain."
      },
      {
        ...
        agencyDetail: "Review CSP configuration change history through Audit Log exports. Config Baseline Engine drift reports show what changed from the approved baseline, enabling agencies to assess whether changes require re-assessment."
      },
      {
        ...
        agencyDetail: "A structured feedback mechanism for agencies to communicate findings and concerns to CSPs is planned. Currently, assessment evidence can be shared through Evidence Chain exports."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review MFA bypass test results to verify CSP phishing resistance. AD Attack Simulation reports show whether privileged access controls withstand real attack techniques. Cloud Attack Paths analysis reveals excessive permission chains across CSP environments.",
    ksis: [
      {
        ...
        agencyDetail: "Review CSP MFA bypass test results showing which attack techniques succeeded or failed. Phishing campaign reports include click rates, credential capture attempts, and MFA bypass success rates — proving MFA resilience with evidence, not just configuration screenshots."
      },
      {
        ...
        agencyDetail: "Review AD Attack Simulation results showing whether CSP privileged access controls resist real attack techniques. Reports detail which privilege escalation paths exist and whether PAM controls effectively contain lateral movement."
      },
      {
        ...
        agencyDetail: "Review AD Domain Connector reports showing stale accounts, group membership sprawl, and orphaned service accounts. Audit Log exports demonstrate account lifecycle management practices."
      },
      {
        ...
        agencyDetail: "Cloud Attack Paths reports reveal excessive permission chains in CSP environments. AD Attack Simulation results show whether privilege escalation is possible, indicating least privilege enforcement gaps."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP JIT access implementations through automated testing of privilege elevation workflows and time-bound access controls."
      },
      {
        ...
        agencyDetail: "Planned capability to validate CSP SSO implementations including federation trust configurations and token security."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP network access control implementations through configuration baseline comparison and segmentation testing."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review Config Baseline drift reports to verify CSPs maintain approved configurations. Audit Log exports demonstrate change documentation practices. Validation Scheduler evidence shows whether security controls are re-validated after changes.",
    ksis: [
      {
        ...
        agencyDetail: "Review Config Baseline reports showing CSP configuration compliance rates and drift history. Validation Scheduler evidence demonstrates automated re-assessment after changes."
      },
      {
        ...
        agencyDetail: "Config Baseline exports show the CSP's configuration inventory and compliance status. Domain Intel asset discovery results reveal whether all assets are tracked in the configuration database."
      },
      {
        ...
        agencyDetail: "Review Audit Log exports showing complete change history with timestamps and attribution. RoE Builder version history demonstrates documentation practices. Evidence Chain records provide tamper-resistant proof of change management."
      },
      {
        ...
        agencyDetail: "Validation Scheduler evidence shows CSPs re-validate security controls after deployments. Agentless BAS and ATT&CK test results before and after changes demonstrate deployment validation practices."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review Domain Intel reports showing CSP external attack surface size and exposed services. DAST Scanner results reveal web application vulnerabilities. Cloud Attack Paths analysis shows whether CSP cloud architecture follows least-privilege and segmentation principles.",
    ksis: [
      {
        ...
        agencyDetail: "Review Domain Intel reports showing the CSP's complete external attack surface — subdomains, open ports, exposed services. DAST Scanner results reveal web application vulnerabilities. Compare attack surface size over time to verify reduction efforts."
      },
      {
        ...
        agencyDetail: "Cloud Attack Paths reports reveal whether CSP environments follow least-functionality principles. AD Attack Simulation results show whether privilege boundaries contain lateral movement."
      },
      {
        ...
        agencyDetail: "Review NGFW Validation results showing whether CSP network segmentation rules are properly configured and enforced. Config Baseline reports track segmentation configuration compliance."
      },
      {
        ...
        agencyDetail: "Review Nuclei Scanner container security results showing image vulnerabilities and misconfigurations. Config Baseline reports demonstrate container hardening compliance."
      },
      {
        ...
        agencyDetail: "Review Config Baseline reports showing DoS protection configuration compliance — WAF rules, rate limiting, and CDN configurations."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP high availability configurations through automated failover testing and recovery time measurement."
      },
      {
        ...
        agencyDetail: "Planned capability to validate CSP resilience through chaos engineering tests and recovery validation exercises."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP software supply chain security through SBOM analysis and dependency vulnerability tracking."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review SIEM detection coverage reports showing which attack techniques the CSP can detect. Detection Rule Generator output demonstrates the CSP's detection engineering maturity. ATT&CK Coverage Matrix reveals monitoring blind spots across the MITRE framework.",
    ksis: [
      {
        ...
        agencyDetail: "Review SIEM Connector configuration showing CSP centralized logging integration. Evidence Chain exports demonstrate comprehensive logging of all security assessment activities."
      },
      {
        ...
        agencyDetail: "Review Detection Rule Generator output showing the CSP's event type coverage. SIEM Connector event mappings demonstrate which security events are captured and forwarded."
      },
      {
        ...
        agencyDetail: "Review ATT&CK Coverage Matrix showing detection percentages across MITRE techniques. SIEM Feedback Loop results prove whether monitoring actually detects real attacks — not just theoretical coverage claims."
      },
      {
        ...
        agencyDetail: "Review Evidence Chain integrity records showing tamper-resistant storage of assessment artifacts. Config Baseline reports demonstrate log protection configuration compliance."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP log retention policies and archival practices through configuration baseline comparison."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review DAST Scanner TLS test results and API Security Testing reports to verify CSP encryption implementations. Email Security Analyzer results show email authentication compliance. Config Baseline reports demonstrate encryption configuration standards.",
    ksis: [
      {
        ...
        agencyDetail: "Review DAST Scanner API test results showing vulnerability findings across CSP APIs. API Security Testing reports demonstrate whether APIs enforce proper authentication, authorization, and input validation."
      },
      {
        ...
        agencyDetail: "Review DAST Scanner TLS test results showing cipher suite strength, certificate validity, and protocol versions across CSP endpoints. Email Security Analyzer reports verify email authentication compliance."
      },
      {
        ...
        agencyDetail: "Review Config Baseline reports showing encryption-at-rest configuration compliance across CSP storage services."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP key management practices including rotation schedules, access controls, and lifecycle management."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP provides and maintains secure configuration guides derived from approved baselines."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP data handling restrictions through configuration analysis and data flow mapping."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP third-party access controls through configuration baseline comparison and access path analysis."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review BIA Report outputs showing CSP business impact analysis. Config Baseline reports demonstrate backup configuration compliance. Recovery validation testing capabilities are planned to provide evidence of actual recovery exercises.",
    ksis: [
      {
        ...
        agencyDetail: "Planned capability to verify CSP recovery procedures through automated failover testing and actual RTO/RPO measurement against stated targets."
      },
      {
        ...
        agencyDetail: "Review BIA Report outputs showing CSP RTO/RPO objectives and their business justification. Config Baseline reports verify recovery configurations align with stated targets."
      },
      {
        ...
        agencyDetail: "Review Config Baseline reports showing CSP backup configuration compliance and alignment with stated recovery objectives."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP disaster recovery plans through automated configuration validation and tabletop exercise support."
      },
    ],
  },
  {
    ...
    agencyValue: "Agencies can review CSP phishing simulation results showing employee click rates, credential capture rates, and improvement trends over time. Purple Team exercise reports demonstrate incident response training effectiveness with real attack scenarios.",
    ksis: [
      {
        ...
        agencyDetail: "Review CSP phishing simulation results showing click rates, credential capture rates, and reporting rates. Track improvement trends over successive campaigns to verify training effectiveness."
      },
      {
        ...
        agencyDetail: "Review Purple Team exercise reports showing CSP incident response team performance — detection times, containment actions, and communication effectiveness during simulated incidents."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP developer training programs through vulnerability trend analysis showing whether common vulnerability classes decrease over time."
      },
      {
        ...
        agencyDetail: "Planned capability to verify CSP privileged user training through targeted social engineering exercises and privilege abuse simulation results."
      },
    ],
  },
];
      ...
      <div className="container">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            ...
            enabling cloud service providers to achieve authorization and federal agencies to evaluate CSP security posture with evidence.
          </p>
        </div>
          ...
          {activeView === "csp" ? (
            <div>
              <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                <span className="text-primary font-display tracking-wider">CSP VIEW</span> — ACE C3 helps cloud service providers achieve and maintain FedRAMP authorization by providing automated security validation, evidence generation, penetration testing across all 6 mandatory attack vectors, and OSCAL export for FedRAMP submission.
              </p>
            ...
            <div>
              <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                <span className="text-primary font-display tracking-wider">AGENCY VIEW</span> — ACE C3 helps federal agencies evaluate and monitor CSP security posture through evidence-based assessment. Rather than relying on CSP self-attestation, agencies can review actual penetration test evidence, detection coverage metrics, and configuration compliance data generated by ACE C3.
              </p>
              <div className="mt-3 p-3 bg-primary/5 border border-primary/20">
                <div className="flex items-start gap-2">
                  <Info className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    <span className="text-primary font-display tracking-wider">HOW AGENCIES USE ACE C3 EVIDENCE</span> — When a CSP uses ACE C3 for their security program, agencies receive evidence-backed assessment data instead of checkbox compliance. Each KSI below describes what evidence agencies can review, what it proves, and how it supports continuous monitoring decisions.
                  </div>
                </div>
              </div>
            </div>

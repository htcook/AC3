    ...
    subSections: [
      {
        ...
        items: [
          { href: "/attack-surface-analysis", icon: Radar, label: "ATTACK SURFACE ANALYSIS" },
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/packet-analysis", icon: Wifi, label: "PACKET ANALYSIS" },
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/cloud-workload-testing", icon: Cloud, label: "CLOUD WORKLOAD TESTING" },
    ...
    subSections: [
      {
        ...
        items: [
          ...
          { href: "/attack-templates", icon: Target, label: "ATTACK TEMPLATES" },
          ...
          { href: "/agent-installer", icon: Download, label: "AGENT INSTALLER" },
        ],
      },
      {
        id: "emu-validation",
    ...
    subSections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/okta-exploitation", icon: Lock, label: "OKTA EXPLOITATION" },
          ...
          { href: "/data-exfil-simulation", icon: Upload, label: "DATA EXFILTRATION" },
    ...
    subSections: [
      {
        ...
        items: [
          ...
          { href: "/context-engine", icon: Cpu, label: "CONTEXT ENGINE" },
          { href: "/threat-group-browser", icon: Swords, label: "THREAT GROUPS" },
          { href: "/conflict-theater", icon: Swords, label: "CONFLICT THEATER" },
          ...
          { href: "/supply-chain-intel", icon: Shield, label: "SUPPLY CHAIN INTEL" },
          { href: "/actor-genome", icon: Cpu, label: "ACTOR GENOME" },
          { href: "/offensive-ops", icon: Cpu, label: "OFFENSIVE OPS" },
        ],
      },
      {
    ...
    subSections: [
      {
        ...
        items: [
          ...
          { href: "/soc-integration-hub", icon: Shield, label: "SOC INTEGRATION HUB" },
          ...
          { href: "/incident-response", icon: BookOpen, label: "IR RUNBOOK" },
          { href: "/dns-security", icon: Shield, label: "DNS SECURITY" },
          ...
          { href: "/mssp-analytics", icon: Building2, label: "MSSP ANALYTICS" },
          ...
          { href: "/arsenal-dashboard", icon: Swords, label: "ARSENAL DASHBOARD" },
          { href: "/utility-playbooks", icon: ScrollText, label: "UTILITY PLAYBOOKS" },
          { href: "/advisory-correlation", icon: Bell, label: "ADVISORY CORRELATION" },
          ...
          { href: "/job-queue", icon: Layers, label: "JOB QUEUE" },
          { href: "/fips-compliance", icon: ShieldCheck, label: "FIPS COMPLIANCE" },
        ],
      },
    ],
  },

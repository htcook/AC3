...
export const TEMPLATE_CATEGORIES: Record<TemplateCategory, { label: string; icon: string; color: string; description: string }> = {
  "it-helpdesk": { label: "IT Help Desk", icon: "Monitor", color: "#0078d4", description: "System notifications, mailbox alerts, and IT support messages" },
  "password-auth": { label: "Password & MFA", icon: "KeyRound", color: "#e74c3c", description: "Password resets, MFA prompts, and authentication alerts" },
  "cloud-services": { label: "Cloud Services", icon: "Cloud", color: "#7c3aed", description: "File sharing, storage alerts, and SaaS notifications" },
  "financial": { label: "Financial", icon: "DollarSign", color: "#f59e0b", description: "Wire transfers, payment requests, and banking alerts" },
  "hr-corporate": { label: "HR & Corporate", icon: "Building2", color: "#10b981", description: "Benefits enrollment, policy updates, and payroll changes" },
  "social-media": { label: "Social Media", icon: "Share2", color: "#3b82f6", description: "LinkedIn, social platform notifications and connection requests" },
  "software-update": { label: "Software Updates", icon: "Download", color: "#6366f1", description: "Application updates, security patches, and compliance installs" },
  "delivery-shipping": { label: "Delivery & Shipping", icon: "Truck", color: "#8b5cf6", description: "Package tracking, delivery notifications, and shipping alerts" },
  "executive-impersonation": { label: "Executive / BEC", icon: "UserCheck", color: "#dc2626", description: "CEO fraud, executive requests, and business email compromise" },
  "calendar-meeting": { label: "Calendar & Meetings", icon: "Calendar", color: "#0891b2", description: "Meeting invites, calendar events, and scheduling requests" },
};

export const PHISHING_TEMPLATES: PhishingTemplate[] = [
  // ============================================================
  // IT HELP DESK TEMPLATES
  // ============================================================
  {
    id: "it-email-migration",
    name: "Email Server Migration Notice",
    category: "it-helpdesk",
    difficulty: "beginner",
    description: "Mimics an IT department email about a server migration requiring account verification. Uses urgency and a legitimate-looking IT support format to trick users into clicking a validation link.",
    subjectLine: "IT Department Notice: Email Server Migration — Action Required",
    previewText: "The IT Department completed an email server migration last night and needs you to verify your account.",
    tags: ["email", "migration", "IT department", "verification", "server"],
    source: "HailBytes/gophish-training-templates",
...
<body>
  ...
  {
    id: "it-mailbox-compromised",
    name: "Mailbox Compromised Security Alert",
    category: "it-helpdesk",
    difficulty: "intermediate",
    description: "Simulates a security alert claiming the user's mailbox has been compromised with unauthorized access detected. Creates panic and urgency to drive immediate action.",
    subjectLine: "🔐 Security Alert: Unauthorized Access Detected on Your Mailbox",
    previewText: "Our security systems have identified suspicious activity on your webmail account.",
    tags: ["security", "compromised", "unauthorized access", "urgent", "mailbox"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "it-system-update",
    name: "Critical System Update Required",
    category: "it-helpdesk",
    difficulty: "beginner",
    description: "Impersonates a Microsoft-style system update notification requiring users to install a critical security patch. Uses official branding and compliance deadlines.",
    subjectLine: "Critical System Update Required — Action Needed by {{deadline}}",
    previewText: "A critical security update has been released that requires immediate installation on your device.",
    tags: ["system update", "Microsoft", "security patch", "compliance", "deadline"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "it-storage-quota",
    name: "Email Storage Quota Exceeded",
    category: "it-helpdesk",
    difficulty: "beginner",
    description: "Warns the user their email storage is almost full and they need to take action to avoid losing incoming messages. A common and effective social engineering tactic.",
    subjectLine: "⚠️ Mailbox Storage Alert: Your account is 97% full",
    previewText: "Your email storage quota has been exceeded. Incoming messages may be rejected.",
    tags: ["storage", "quota", "mailbox full", "email", "IT"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "it-webmail-upgrade",
    name: "Webmail System Upgrade Notification",
    category: "it-helpdesk",
    difficulty: "beginner",
    description: "Announces a webmail system upgrade with new features, requiring users to activate their upgraded account. Leverages excitement about new features combined with a deadline.",
    subjectLine: "🎉 Webmail Upgrade Complete — Activate Your New Features",
    previewText: "Your webmail has been upgraded with new features. Please activate your account to access them.",
    tags: ["webmail", "upgrade", "new features", "activation", "IT"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "it-servicenow-ticket",
    name: "ServiceNow IT Ticket Update",
    category: "it-helpdesk",
    difficulty: "advanced",
    description: "Mimics a ServiceNow ticket notification about an IT request requiring approval. Highly realistic for organizations using ServiceNow for IT service management.",
    subjectLine: "ServiceNow: INC0042817 — Your IT Request Requires Action",
    previewText: "A ticket has been updated in ServiceNow that requires your immediate attention.",
    tags: ["ServiceNow", "ITSM", "ticket", "help desk", "incident"],
    source: "Custom — Based on real ServiceNow notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  // PASSWORD & MFA TEMPLATES
  // ============================================================
  {
    id: "auth-password-expiry",
    name: "Password Expiration Warning",
    category: "password-auth",
    difficulty: "beginner",
    description: "Classic password expiration alert mimicking Microsoft 365 or Active Directory notifications. One of the most effective phishing templates due to its familiarity.",
    subjectLine: "Action Required: Your password will expire in 24 hours",
    previewText: "Your Microsoft 365 password will expire in 24 hours. Reset now to avoid disruption.",
    tags: ["password", "expiration", "Microsoft 365", "Active Directory", "reset"],
    source: "Abnormal AI / Industry Standard",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  {
    id: "auth-mfa-fatigue",
    name: "MFA System Update — Approve Prompt",
    category: "password-auth",
    difficulty: "advanced",
    description: "Exploits MFA fatigue by posing as IT support requesting users approve an MFA prompt to finalize a system update. Tests awareness of push notification attacks.",
    subjectLine: "IT Security: MFA System Update — Please Approve Verification Prompt",
    previewText: "We've made changes to our MFA system. You may receive a verification prompt—please approve it.",
    tags: ["MFA", "two-factor", "push notification", "fatigue", "IT security"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "auth-microsoft-security-alert",
    name: "Microsoft Account Security Alert",
    category: "password-auth",
    difficulty: "intermediate",
    description: "Mimics a Microsoft account security alert about a sign-in from an unrecognized device and location. Includes realistic location and device details.",
    subjectLine: "Microsoft Account Security Alert — Unusual Sign-in Activity",
    previewText: "We detected something unusual about a recent sign-in to your Microsoft account.",
    tags: ["Microsoft", "security alert", "sign-in", "unusual activity", "account"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  // ============================================================
  {
    id: "cloud-dropbox-share",
    name: "Dropbox File Share Notification",
    category: "cloud-services",
    difficulty: "beginner",
    description: "Mimics a Dropbox file sharing notification. Exploits trust in cloud file sharing platforms and curiosity about shared documents.",
    subjectLine: "{{.FirstName}}, someone shared a file with you on Dropbox",
    previewText: "A colleague has shared an important document with you via Dropbox.",
    tags: ["Dropbox", "file share", "cloud", "document", "collaboration"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  },
  {
    ...
    category: "cloud-services",
    difficulty: "beginner",
    description: "Mimics a Google Drive sharing notification. Uses Google's visual style and a compelling document name to entice clicks.",
    subjectLine: "Document shared with you: \"Annual Budget Proposal 2025\"",
    previewText: "Finance Department has shared a Google Docs document with you.",
    tags: ["Google Drive", "Google Docs", "file share", "cloud", "document"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "cloud-onedrive-share",
    name: "OneDrive/SharePoint File Share",
    category: "cloud-services",
    difficulty: "intermediate",
    description: "Mimics a Microsoft OneDrive or SharePoint file sharing notification. Particularly effective in Microsoft 365 environments.",
    subjectLine: "{{sender}} shared \"Confidential — Board Meeting Notes\" with you",
    previewText: "A OneDrive for Business document has been shared with you.",
    tags: ["OneDrive", "SharePoint", "Microsoft 365", "file share", "cloud"],
    source: "Custom — Based on real Microsoft notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  {
    id: "fin-wire-transfer",
    name: "Urgent Wire Transfer Request",
    category: "financial",
    difficulty: "advanced",
    description: "Classic BEC (Business Email Compromise) template impersonating a CEO requesting an urgent wire transfer. Tests employee awareness of executive fraud.",
    subjectLine: "Urgent: Wire Transfer Needed Today — Confidential",
    previewText: "I need you to process a wire transfer urgently. I'm in meetings and can't call.",
    tags: ["wire transfer", "BEC", "CEO fraud", "urgent", "financial"],
    source: "Abnormal AI / criggs626",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  {
    id: "fin-vendor-payment",
    name: "Vendor Payment Details Update",
    category: "financial",
    difficulty: "advanced",
    description: "Impersonates a known vendor requesting a change in banking details for an upcoming payment. A sophisticated BEC variant targeting accounts payable.",
    subjectLine: "Updated Banking Instructions for Invoice #INV-2025-0392",
    previewText: "Please note our new remittance details for the upcoming payment.",
    tags: ["vendor", "payment", "banking", "invoice", "BEC"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  // ============================================================
  {
    ...
    name: "Benefits Enrollment — Final Reminder",
    category: "hr-corporate",
    difficulty: "beginner",
    description: "Mimics an HR benefits enrollment deadline notification. Highly effective during actual enrollment periods. Exploits fear of missing out on benefits.",
    subjectLine: "Final Reminder: Benefits Enrollment Closes Tomorrow",
    previewText: "Click below to finalize your 2025 benefits elections before the window closes.",
    tags: ["HR", "benefits", "enrollment", "deadline", "open enrollment"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "hr-payroll-change",
    name: "Payroll Direct Deposit Confirmation",
    category: "hr-corporate",
    difficulty: "intermediate",
    description: "Impersonates HR/Payroll asking employees to confirm direct deposit information. Targets sensitive financial data under the guise of routine payroll maintenance.",
    subjectLine: "Action Required: Confirm Your Direct Deposit Details",
    previewText: "Please confirm your direct deposit information to avoid payroll delays.",
    tags: ["payroll", "direct deposit", "HR", "banking", "confirmation"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "hr-policy-signature",
    name: "Updated Company Policy — Signature Required",
    category: "hr-corporate",
    difficulty: "intermediate",
    description: "Mimics an HR compliance notification requiring employees to review and sign an updated policy document. Uses a malicious attachment or link disguised as a policy PDF.",
    subjectLine: "Please Review: Updated Information Security Policy — Signature Required",
    previewText: "All employees are required to review and sign the updated security policy by Friday.",
    tags: ["policy", "compliance", "signature", "HR", "document"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  // ============================================================
  {
    id: "social-linkedin-connection",
    name: "LinkedIn Connection Request",
    category: "social-media",
    difficulty: "beginner",
    description: "Mimics a LinkedIn connection request or profile view notification. Exploits professional networking curiosity.",
    subjectLine: "{{.FirstName}}, you have 3 new connection requests on LinkedIn",
    previewText: "A recruiter from a Fortune 500 company wants to connect with you.",
    tags: ["LinkedIn", "connection", "networking", "social media", "recruiter"],
    source: "HailBytes/gophish-training-templates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  {
    id: "sw-zoom-update",
    name: "Zoom Security Update Required",
    category: "software-update",
    difficulty: "intermediate",
    description: "Impersonates Zoom requesting a mandatory security update. Particularly effective for remote workers who rely heavily on video conferencing.",
    subjectLine: "Required: Zoom Security Update — Install Before Your Next Meeting",
    previewText: "A critical security update for Zoom is required to continue using the application.",
    tags: ["Zoom", "security update", "video conferencing", "software", "remote work"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  // ============================================================
  // DELIVERY & SHIPPING TEMPLATES
  // ============================================================
  {
    id: "ship-dhl-delivery",
    name: "DHL Package Delivery Notification",
    category: "delivery-shipping",
    difficulty: "beginner",
    description: "Mimics a DHL delivery notification about a package requiring address confirmation. Effective during holiday seasons and for online shoppers.",
    subjectLine: "DHL: Your package is waiting — Delivery address confirmation needed",
    previewText: "We attempted to deliver your package but need address confirmation.",
    tags: ["DHL", "delivery", "package", "shipping", "tracking"],
    source: "criggs626/PhishingTemplates",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  // EXECUTIVE / BEC TEMPLATES
  // ============================================================
  {
    id: "bec-ceo-gift-cards",
    name: "CEO Gift Card Request",
    category: "executive-impersonation",
    difficulty: "intermediate",
    description: "Classic CEO gift card scam where the 'CEO' asks an employee to purchase gift cards for a client appreciation event. One of the most common BEC variants.",
    subjectLine: "Quick favor needed — Confidential",
    previewText: "Are you available? I need your help with something urgent.",
    tags: ["CEO", "gift cards", "BEC", "impersonation", "social engineering"],
    source: "Industry Standard BEC Template",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  {
    id: "cal-meeting-invite",
    name: "Calendar Invite — Strategy Planning Session",
    category: "calendar-meeting",
    difficulty: "advanced",
    description: "Mimics a calendar event invitation with a malicious link in the meeting description. Calendars are often overlooked as a phishing vector.",
    subjectLine: "[Invite] Strategy Planning Session with Senior Leadership",
    previewText: "You've been invited to a strategy planning session. Please review the agenda.",
    tags: ["calendar", "meeting", "invite", "strategy", "leadership"],
    source: "Abnormal AI",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  // ============================================================
  // ADDITIONAL IT HELP DESK TEMPLATES
  // ============================================================
  {
    id: "it-zendesk-ticket",
    name: "Zendesk Support Ticket Update",
    category: "it-helpdesk",
    difficulty: "intermediate",
    description: "Mimics a Zendesk support ticket notification requiring user action. Realistic for organizations using Zendesk for internal or external support.",
    subjectLine: "Zendesk: Ticket #48291 Updated — Your Response Needed",
    previewText: "Your IT support ticket has been updated and requires your response.",
    tags: ["Zendesk", "support ticket", "help desk", "ITSM", "response needed"],
    source: "Custom — Based on real Zendesk notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  {
    id: "it-vpn-certificate",
    name: "VPN Certificate Expiration Notice",
    category: "it-helpdesk",
    difficulty: "intermediate",
    description: "Warns that the user's VPN certificate is expiring and they need to renew it to maintain remote access. Particularly effective for remote/hybrid workers.",
    subjectLine: "VPN Access Alert: Your certificate expires in 48 hours",
    previewText: "Your VPN certificate is about to expire. Renew now to maintain remote access.",
    tags: ["VPN", "certificate", "remote access", "expiration", "IT security"],
    source: "Custom — Based on real enterprise VPN notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  {
    ...
    category: "cloud-services",
    difficulty: "intermediate",
    description: "Mimics a DocuSign electronic signature request. Highly effective because DocuSign is widely used for legitimate business documents.",
    subjectLine: "DocuSign: Please sign — Employment Agreement Amendment",
    previewText: "HR has sent you a document to review and sign via DocuSign.",
    tags: ["DocuSign", "signature", "e-sign", "document", "HR"],
    source: "Custom — Based on real DocuSign notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  // ============================================================
  {
    id: "fin-invoice-payment",
    name: "Overdue Invoice — Payment Required",
    category: "financial",
    difficulty: "intermediate",
    description: "Mimics an overdue invoice notification from a vendor's accounting department. Creates urgency through late payment penalties and service suspension threats.",
    subjectLine: "OVERDUE: Invoice #INV-8847 — Payment Required Immediately",
    previewText: "Your invoice is past due. Please remit payment to avoid service interruption.",
    tags: ["invoice", "overdue", "payment", "vendor", "accounts payable"],
    source: "Custom — Based on real vendor invoice notifications",
    htmlContent: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
export function getTemplatesByDifficulty(difficulty: PhishingTemplate["difficulty"]): PhishingTemplate[] {
  return PHISHING_TEMPLATES.filter(t => t.difficulty === difficulty);
}

...
CREATE TABLE `ics_devices` (
	...
	`icd_discovery_source` enum('shodan','censys','scanforge-discovery','protocol_scan','manual','caldera') DEFAULT 'manual',
...
CREATE TABLE `user_platform_credentials` (
	`id` int AUTO_INCREMENT NOT NULL,
	`user_id` int NOT NULL,
	`platform` enum('hackerone','bugcrowd','intigriti','synack','yeswehack','open_bug_bounty','immunefi','custom') NOT NULL,
	`display_name` varchar(255) NOT NULL,

...
CREATE INDEX `lte_review_status_idx` ON `llm_training_examples` (`te_review_status`);--> statement-breakpoint
...
CREATE INDEX `rtc_created_by_idx` ON `redteam_campaigns` (`rtc_created_by`);--> statement-breakpoint

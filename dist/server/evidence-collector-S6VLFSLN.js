...
async function collectExploitEvidence(ctx) {
  ...
  try {
    const { getPersistedLearningStats } = await import("./exploit-learning-engine-2JCUP76U.js");
...
async function validateEvidenceIntegrity(ctx, exploitEvidence) {
  ...
  try {
    const { buildProvenance, evidenceGate, createIntegrityEnvelope, recordCustodyEvent } = await import("./evidence-integrity-BRPCBQMW.js");

...
} from "./chunk-5LOQ7QVJ.js";
import "./chunk-JPE2HEB3.js";
import "./chunk-LZG4JJ5P.js";
import {
  init_llm,
  invokeLLM
...
async function resolveExecutionInsights(techniqueIds) {
  try {
    const { getHistoryForTechnique, calculateTechniqueReliability } = await import("./c2-learning-engine-BEFPLJKZ.js");
    const insights = [];
...
async function learnNewTTPs(actorNames, ctx) {
  ...
  try {
    const { getExecutionHistory } = await import("./c2-learning-engine-BEFPLJKZ.js");

...
async function initDynamicCache() {
  ...
  try {
    const { getAllTemplateMappings } = await import("./nuclei-findings-persistence-ZDRYKRVL.js");
...
async function resolveNucleiTemplate(params) {
  ...
  if (cve) {
    try {
      const { lookupDynamicTemplateMapping } = await import("./nuclei-findings-persistence-ZDRYKRVL.js");
...
async function autoMapExploitToNucleiTemplate(params) {
  ...
  if (nucleiTemplateId) {
    try {
      const { recordTemplateMapping } = await import("./nuclei-findings-persistence-ZDRYKRVL.js");

...
var init_scan_service_url = __esm({
  "server/lib/scan-service-url.ts"() {
    ...
    SCANFORGE_DEDICATED_DOMAIN = "scanforge.aceofcloud.io";
    SCANFORGE_DEDICATED_URL = `https://${SCANFORGE_DEDICATED_DOMAIN}:4443`;
    SCANFORGE_DEDICATED_URL_HTTP = `http://${SCANFORGE_DEDICATED_IP}:4000`;

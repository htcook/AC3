  ...
  async getClient() {
    if (!this.clientPromise) {
      this.clientPromise = (async () => {
        const { MsfClient } = await import("./msf-client-7TALEI3I.js");
        ...
        if (ENV.MSF_RPC_HOST) {
          const { MsfClient: MC } = await import("./msf-client-7TALEI3I.js");
          const client = new MC({
...
async function executeGoPhishStep(plan, step) {
  ...
  try {
    const { fetchGophish } = await import("./shared-7XXOI5TH.js");
    let campaignId;

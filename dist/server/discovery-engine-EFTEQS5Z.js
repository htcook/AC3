...
async function enrichFromThreatIntel(hosts) {
  try {
    const { enrichThreatIntelligence } = await import("./bug-bounty-intelligence-PLCA7TIS.js");
...
async function enrichFromOpSec(hosts) {
  try {
    const { enrichOpSec } = await import("./bug-bounty-intelligence-PLCA7TIS.js");
...
async function runDiscoveryPipeline(targets, config, onProgress) {
  ...
  try {
    ...
    const { createCarverRiskCardsBatch } = await import("./db-UO2A3C4N.js");

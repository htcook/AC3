...
async function enrichFromThreatIntel(hosts) {
  try {
    const { enrichThreatIntelligence } = await import("./bug-bounty-intelligence-YOUPDG6U.js");
...
async function enrichFromOpSec(hosts) {
  try {
    const { enrichOpSec } = await import("./bug-bounty-intelligence-YOUPDG6U.js");
...
async function runDiscoveryPipeline(targets, config, onProgress) {
  ...
  try {
    ...
    const { createCarverRiskCardsBatch } = await import("./db-TULZR6OH.js");

...
async function collectExploitEvidence(ctx) {
  ...
  try {
    const { getPersistedLearningStats } = await import("./exploit-learning-engine-XEAHUFZU.js");
...
async function validateEvidenceIntegrity(ctx, exploitEvidence) {
  ...
  try {
    const { buildProvenance, evidenceGate, createIntegrityEnvelope, recordCustodyEvent } = await import("./evidence-integrity-M7NV6U35.js");

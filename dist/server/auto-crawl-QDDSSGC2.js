...
async function triggerAutoCrawl(scanId, domain) {
  ...
  try {
    ...
    const { discoveredAssets, webCrawlResults, webCrawlJobs, domainIntelScans } = await import("./schema-J7P4MLKR.js");
    ...
    try {
      ...
      const { resolveAndEnrichEntity, calculateFinancialImpact } = await import("./entity-resolver-IB6TKOP7.js");
    ...
    try {
      const { listIntegrations, getClientForIntegration, cacheVendorData } = await import("./vendors-B3DEPVOY.js");
      ...
      if (enabledIntegrations.length > 0) {
        ...
        for (const integration of enabledIntegrations) {
          try {
            ...
            const { VENDOR_METADATA } = await import("./vendors-B3DEPVOY.js");

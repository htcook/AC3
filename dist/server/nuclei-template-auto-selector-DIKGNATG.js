...
async function initDynamicCache() {
  ...
  try {
    const { getAllTemplateMappings } = await import("./nuclei-findings-persistence-GLKXR4IA.js");
...
async function resolveNucleiTemplate(params) {
  ...
  if (cve) {
    try {
      const { lookupDynamicTemplateMapping } = await import("./nuclei-findings-persistence-GLKXR4IA.js");
...
async function autoMapExploitToNucleiTemplate(params) {
  ...
  if (nucleiTemplateId) {
    try {
      const { recordTemplateMapping } = await import("./nuclei-findings-persistence-GLKXR4IA.js");

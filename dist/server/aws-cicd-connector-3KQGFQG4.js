...
async function scanServerPreFlight() {
  try {
    const { checkDoScanServiceHealth } = await import("./do-scan-api-C5YK7YCK.js");
...
async function executeCicdScan(request) {
  ...
  try {
    const { correlateCicdFindings } = await import("./cicd-threat-correlator-6OY646UI.js");
...
async function runZapCicd(targetUrl) {
  const findings = [];
  try {
    const { getActiveZapUrl } = await import("./scan-service-url-5ZA2MUWH.js");

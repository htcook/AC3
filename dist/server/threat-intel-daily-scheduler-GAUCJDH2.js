...
async function runDailyThreatIntelPipeline() {
  ...
  try {
    const { runFullIngest } = await import("./threat-intel-ingest-KLDL24SJ.js");
  ...
  try {
    const { runIntelligenceCrawl } = await import("./threat-actor-crawler-3XG5V2G6.js");
  ...
  try {
    const { runTargetedEnrichment } = await import("./threat-actor-crawler-3XG5V2G6.js");
  ...
  try {
    const { runGovernmentIntelIngest } = await import("./government-intel-sources-HA4PVK35.js");
  ...
  try {
    const { runIcsScadaIntelIngest } = await import("./ics-scada-intel-WD6CZPRG.js");
  ...
  try {
    const { runLeakSiteMonitor } = await import("./ransomware-leak-monitor-NXERTM2W.js");
  ...
  try {
    const { refreshCveDatabase, getCveRefreshStats } = await import("./nvd-cve-refresh-LWJ2FDHH.js");
  ...
  try {
    ...
    if (db) {
      const { incidentReports } = await import("./schema-RDUWS2ES.js");

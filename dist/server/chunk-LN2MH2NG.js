...
var DEFAULT_SAFETY_PROFILE, RED_TEAM_SAFETY_PROFILE, proofRateLimiter;
...
async function executeEnumeration(state, engagement, operatorCtx) {
  const { executeEnumeration: runEnumerationPhase } = await import("./engagement-phase-enumeration-XAA4KRNL.js");
...
async function executeVulnDetection(state, engagement, operatorCtx) {
  ...
  const { executeVulnPrep } = await import("./vuln-prep-QJQIKG4V.js");
  const vulnPrepCtx = {
    state,
    engagement,
    operatorCtx,
  ...
  const { executeZapScanning } = await import("./zap-scanner-M6XDLNG3.js");
  ...
  const { executeInjectionScanning } = await import("./injection-scanner-WQ765ZMX.js");
  ...
  const { executeCredentialTesting } = await import("./credential-tester-IPUXIELU.js");
  ...
  const { executeVulnCorrelation } = await import("./vuln-correlation-7DGYNQZR.js");
...
async function executeExploitation(state, engagement, operatorCtx) {
  const { executeExploitation: runExploitPhase } = await import("./engagement-phase-exploitation-PWHD3XN6.js");
  return runExploitPhase(state, engagement, operatorCtx);
}
async function executePostExploit(state, engagement, operatorCtx) {
  const { executePostExploit: runPostExploitPhase } = await import("./engagement-phase-post-exploit-ZRUCO2H3.js");

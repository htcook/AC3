...
async function runHealthCheckForIntegration(integrationId) {
  const { getCustomerIntegrationByIntegrationId, createHealthCheck, updateCustomerIntegration } = await import("./db-D773P4Y2.js");
...
async function runAllHealthChecks() {
  try {
    const { getCustomerIntegrationsByStatus } = await import("./db-D773P4Y2.js");

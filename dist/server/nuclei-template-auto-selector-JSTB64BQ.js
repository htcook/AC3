...
async function initDynamicCache() {
  ...
  try {
    const { getAllTemplateMappings } = await import("./nuclei-findings-persistence-Z4YGLL35.js");
...
async function resolveNucleiTemplate(params) {
  ...
  if (cve) {
    try {
      const { lookupDynamicTemplateMapping } = await import("./nuclei-findings-persistence-Z4YGLL35.js");
...
async function autoMapExploitToNucleiTemplate(params) {
  ...
  if (nucleiTemplateId) {
    try {
      const { recordTemplateMapping } = await import("./nuclei-findings-persistence-Z4YGLL35.js");

...
async function runLabScan(sessionId, targetUrl, scanProfile) {
  ...
  try {
    ...
    try {
      const { executeRawCommandViaQueue } = await import("./job-queue-bridge-I2QGZ5TO.js");
    ...
    try {
      const { executeToolViaQueue } = await import("./job-queue-bridge-I2QGZ5TO.js");
      let discoveryFlags;
    ...
    const { executeRawCommandViaQueue: execNucleiCmd } = await import("./job-queue-bridge-I2QGZ5TO.js");
    try {

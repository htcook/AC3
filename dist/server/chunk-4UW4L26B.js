...
async function runHealthCheckForIntegration(integrationId) {
  const { getCustomerIntegrationByIntegrationId, createHealthCheck, updateCustomerIntegration } = await import("./db-65DPEQYH.js");
...
async function runAllHealthChecks() {
  try {
    const { getCustomerIntegrationsByStatus } = await import("./db-65DPEQYH.js");

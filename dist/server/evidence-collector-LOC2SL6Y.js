...
async function collectExploitEvidence(ctx) {
  ...
  try {
    const { getPersistedLearningStats } = await import("./exploit-learning-engine-K44UI5MU.js");
...
async function validateEvidenceIntegrity(ctx, exploitEvidence) {
  ...
  try {
    const { buildProvenance, evidenceGate, createIntegrityEnvelope, recordCustodyEvent } = await import("./evidence-integrity-M5UCL3TI.js");

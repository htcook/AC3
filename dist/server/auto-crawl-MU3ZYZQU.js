...
async function triggerAutoCrawl(scanId, domain) {
  ...
  try {
    ...
    const { discoveredAssets, webCrawlResults, webCrawlJobs, domainIntelScans } = await import("./schema-TZDA52RN.js");
    ...
    try {
      ...
      const { resolveAndEnrichEntity, calculateFinancialImpact } = await import("./entity-resolver-ISZLMYNC.js");
    ...
    try {
      const { listIntegrations, getClientForIntegration, cacheVendorData } = await import("./vendors-A4CZHI43.js");
      ...
      if (enabledIntegrations.length > 0) {
        ...
        for (const integration of enabledIntegrations) {
          try {
            ...
            const { VENDOR_METADATA } = await import("./vendors-A4CZHI43.js");

...
async function triggerAutoCrawl(scanId, domain) {
  ...
  try {
    ...
    const { discoveredAssets, webCrawlResults, webCrawlJobs, domainIntelScans } = await import("./schema-RLVX4V4P.js");
    ...
    try {
      ...
      const { resolveAndEnrichEntity, calculateFinancialImpact } = await import("./entity-resolver-NVQOH6ZD.js");
    ...
    try {
      const { listIntegrations, getClientForIntegration, cacheVendorData } = await import("./vendors-F36DCNAK.js");
      ...
      if (enabledIntegrations.length > 0) {
        ...
        for (const integration of enabledIntegrations) {
          try {
            ...
            const { VENDOR_METADATA } = await import("./vendors-F36DCNAK.js");

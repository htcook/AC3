...
async function correlateFindings(engagementId, zapScanId) {
  ...
  let burpFindings = [];
  try {
    const dbModule = await import("./db-UO2A3C4N.js");
...
async function getCrossToolCoverage(engagementId) {
  ...
  try {
    const dbModule2 = await import("./db-UO2A3C4N.js");

...
var COMMERCIAL_SCANNER_CONNECTORS = [
  // ─── Vulnerability Management Platforms ─────────────────────────────
  {
    id: "tenable_io",
    name: "tenable_io",
    displayName: "Tenable.io (Nessus)",
    ...
    authMethod: "api_key",
    envVarKeys: ["TENABLE_ACCESS_KEY", "TENABLE_SECRET_KEY"],
    dataTypes: ["vulnerabilities", "compliance_findings", "asset_inventory", "cve_detection", "misconfigurations"],
    inputTypes: ["ip", "domain", "cidr"],
    outputTypes: ["ip", "subdomain"],
    ...
    tags: ["fedramp_high", "nist_800_53", "dod_stig", "cmmc", "enterprise", "nessus"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  {
    ...
    authMethod: "api_key",
    envVarKeys: ["QUALYS_API_URL", "QUALYS_USERNAME", "QUALYS_PASSWORD"],
    ...
    tags: ["fedramp_high", "nist_800_53", "dod_stig", "cmmc", "pci_asv", "continuous_monitoring"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  {
    ...
    tags: ["fedramp", "nist_800_53", "dod_stig", "risk_scoring", "nexpose"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  ...
  },
  {
    ...
    pipelineStages: ["vuln_detection"],
    authMethod: "oauth2",
    envVarKeys: ["CHECKMARX_BASE_URL", "CHECKMARX_CLIENT_ID", "CHECKMARX_CLIENT_SECRET", "CHECKMARX_TENANT"],
    dataTypes: ["sast_findings", "sca_findings", "iac_findings", "api_security_findings", "supply_chain_risks"],
    inputTypes: ["repository", "binary"],
    outputTypes: ["subdomain"],
  ...
  // ─── Cloud Security Posture Management (CSPM) ──────────────────────
  {
    id: "prisma_cloud",
    name: "prisma_cloud",
    displayName: "Prisma Cloud (Palo Alto)",
  ...
  },
  {
    ...
    pipelineStages: ["vuln_detection", "monitoring"],
    authMethod: "oauth2",
    envVarKeys: ["WIZ_API_URL", "WIZ_CLIENT_ID", "WIZ_CLIENT_SECRET"],
    ...
    tags: ["fedramp", "nist_800_53", "cspm", "agentless", "attack_path", "cloud_native"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  // ─── Endpoint / Runtime Security ───────────────────────────────────
  {
    ...
    pipelineStages: ["vuln_detection", "monitoring"],
    authMethod: "oauth2",
    envVarKeys: ["CROWDSTRIKE_CLIENT_ID", "CROWDSTRIKE_CLIENT_SECRET", "CROWDSTRIKE_BASE_URL"],
    dataTypes: ["endpoint_vulnerabilities", "detection_events", "host_inventory", "ioc_matches", "zero_day_alerts"],
    inputTypes: ["ip", "hostname"],
    outputTypes: ["ip"],
    ...
    tags: ["fedramp_high", "dod_il5", "nist_800_53", "edr", "endpoint", "zero_trust"],
    supportsPassiveOnly: false,
    requiresActiveProbing: false,
    isBuiltIn: true
  },
  {
    ...
    tags: ["fedramp_high", "dod_il5", "nist_800_53", "cmmc", "endpoint", "microsoft_365"],
    supportsPassiveOnly: false,
    requiresActiveProbing: false,
    isBuiltIn: true
  },
  // ─── Container & Supply Chain Security ─────────────────────────────
  {
    ...
    tags: ["fedramp", "dod_iron_bank", "nist_800_53", "containers", "sbom", "supply_chain"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  ...
  {
    id: "burp_suite_enterprise",
    name: "burp_suite_enterprise",
    displayName: "Burp Suite Enterprise",
    description: "Enterprise-grade DAST \u2014 automated web vulnerability scanning with CI/CD integration and scheduled scans",
    category: "scanner",
    licenseModel: "byol",
    pipelineStages: ["vuln_detection"],
    authMethod: "api_key",
    envVarKeys: ["BURP_LICENSE_EMAIL", "BURP_LICENSE_PASSWORD", "BURP_ENTERPRISE_URL", "BURP_ENTERPRISE_API_KEY"],
    ...
    docsUrl: "https://portswigger.net/burp/documentation/enterprise/api",
    tags: ["nist_800_53", "dast", "web", "enterprise", "cicd", "scheduled"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  {
    ...
    pipelineStages: ["vuln_detection"],
    authMethod: "api_key",
    envVarKeys: ["APPSCAN_API_KEY", "APPSCAN_API_SECRET", "APPSCAN_BASE_URL"],
    dataTypes: ["dast_findings", "sast_findings", "iast_findings", "sca_findings"],
    inputTypes: ["url", "repository", "binary"],
    outputTypes: ["subdomain"],
    ...
    tags: ["fedramp", "nist_800_53", "dast", "sast", "iast", "enterprise"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  {
    ...
    tags: ["nist_800_53", "dast", "web", "proof_based", "owasp"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  // ─── Network & Infrastructure Scanning ─────────────────────────────
  {
    ...
    tags: ["nist_800_53", "dod_stig", "on_premises", "nessus", "analytics"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  },
  {
    id: "qualys_was",
    name: "qualys_was",
    displayName: "Qualys Web Application Scanning (WAS)",
    ...
    tags: ["fedramp_high", "nist_800_53", "dast", "web", "api_scanning"],
    supportsPassiveOnly: false,
    requiresActiveProbing: true,
    isBuiltIn: true
  }

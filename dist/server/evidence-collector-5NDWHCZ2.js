...
async function collectExploitEvidence(ctx) {
  ...
  try {
    const { getPersistedLearningStats } = await import("./exploit-learning-engine-YKOACPDP.js");
...
async function validateEvidenceIntegrity(ctx, exploitEvidence) {
  ...
  try {
    const { buildProvenance, evidenceGate, createIntegrityEnvelope, recordCustodyEvent } = await import("./evidence-integrity-5K6EKTGU.js");

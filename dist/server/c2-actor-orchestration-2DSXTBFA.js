...
} from "./chunk-FKLFCDUR.js";
import "./chunk-A5Z5DESG.js";
import "./chunk-IQDQH35M.js";
import {
  init_llm,
  invokeLLM
...
async function resolveExecutionInsights(techniqueIds) {
  try {
    const { getHistoryForTechnique, calculateTechniqueReliability } = await import("./c2-learning-engine-4XRTKGNF.js");
    const insights = [];
...
async function learnNewTTPs(actorNames, ctx) {
  ...
  try {
    const { getExecutionHistory } = await import("./c2-learning-engine-4XRTKGNF.js");

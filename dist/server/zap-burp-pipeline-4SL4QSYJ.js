import {
  ...
  init_burp_auto_scan,
  launchBurpAutoScan
} from "./chunk-NATLCBRU.js";
import "./chunk-CIEOSGAI.js";
...
import "./chunk-R3UICRXX.js";
import "./chunk-QKACYX3L.js";
...
async function correlateFindings(engagementId, zapScanId) {
  ...
  let burpFindings = [];
  try {
    const dbModule = await import("./db-JLHOBMS4.js");
...
async function getCrossToolCoverage(engagementId) {
  ...
  try {
    const dbModule2 = await import("./db-JLHOBMS4.js");

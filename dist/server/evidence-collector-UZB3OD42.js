...
async function collectExploitEvidence(ctx) {
  ...
  try {
    const { getPersistedLearningStats } = await import("./exploit-learning-engine-BCIJJGCT.js");
...
async function validateEvidenceIntegrity(ctx, exploitEvidence) {
  ...
  try {
    const { buildProvenance, evidenceGate, createIntegrityEnvelope, recordCustodyEvent } = await import("./evidence-integrity-YHK6QKMN.js");

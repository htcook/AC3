...
var SCAN_HOST_RAW, SCANFORGE_DEDICATED_IP, SCANFORGE_DEDICATED_DOMAIN, SCANFORGE_DEDICATED_URL, SCANFORGE_DEDICATED_URL_HTTP, LEGACY_SCAN_URL, LEGACY_SCAN_IP, LEGACY_ZAP_URL, SCAN_SERVICE_URL, SCAN_API_KEY, _dedicatedHealthy, _lastHealthCheck, HEALTH_CHECK_INTERVAL_MS, _zapHealthy, _lastZapCheck;
var init_scan_service_url = __esm({
  "server/lib/scan-service-url.ts"() {
    SCAN_HOST_RAW = process.env.SCAN_SERVER_HOST || "";
    SCANFORGE_DEDICATED_IP = process.env.SCANFORGE_HOST || process.env.SCAN_SERVER_HOST || "";
    SCANFORGE_DEDICATED_DOMAIN = process.env.SCANFORGE_DOMAIN || "scanforge.aceofcloud.io";
    SCANFORGE_DEDICATED_URL = process.env.SCANFORGE_URL || `https://${SCANFORGE_DEDICATED_DOMAIN}:4443`;
    SCANFORGE_DEDICATED_URL_HTTP = SCANFORGE_DEDICATED_IP ? `http://${SCANFORGE_DEDICATED_IP}:4000` : "";
    LEGACY_SCAN_URL = process.env.LEGACY_SCAN_URL || "https://scan.aceofcloud.io";
    LEGACY_SCAN_IP = process.env.SCAN_SERVER_HOST || "";
    LEGACY_ZAP_URL = process.env.ZAP_BASE_URL || (LEGACY_SCAN_IP ? `http://${LEGACY_SCAN_IP}:8092` : "");
    SCAN_SERVICE_URL = (() => {
    ...
    SCAN_API_KEY = process.env.SCAN_API_KEY || "2f7aec9e8d3ab1e9b2fe2bb94dfc57a1cb142f4a7cbd5443";
...
export {
  ...
  SCANFORGE_DEDICATED_DOMAIN,
  SCANFORGE_DEDICATED_URL,
  SCANFORGE_DEDICATED_URL_HTTP,
  LEGACY_SCAN_URL,
  LEGACY_SCAN_IP,
  LEGACY_ZAP_URL,
  SCAN_SERVICE_URL,

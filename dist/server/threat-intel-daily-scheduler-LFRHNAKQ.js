...
async function runDailyThreatIntelPipeline() {
  ...
  try {
    const { syncAllThreatIntelFeeds } = await import("./threat-intel-rss-5HPC5FYM.js");
  ...
  try {
    const { runFullIngest } = await import("./threat-intel-ingest-CJ5ETMIM.js");
  ...
  try {
    const { runIntelligenceCrawl } = await import("./threat-actor-crawler-W2NNUN3U.js");
  ...
  try {
    const { runTargetedEnrichment } = await import("./threat-actor-crawler-W2NNUN3U.js");
  ...
  try {
    const { runGovernmentIntelIngest } = await import("./government-intel-sources-76GEZDWN.js");
  ...
  try {
    const { runIcsScadaIntelIngest } = await import("./ics-scada-intel-PQJ2GP25.js");
  ...
  try {
    const { runLeakSiteMonitor } = await import("./ransomware-leak-monitor-WSXC3ENX.js");
  ...
  try {
    const { refreshCveDatabase, getCveRefreshStats } = await import("./nvd-cve-refresh-NRNWHNZQ.js");
  ...
  try {
    ...
    if (db) {
      const { incidentReports } = await import("./schema-XOTPZHKC.js");

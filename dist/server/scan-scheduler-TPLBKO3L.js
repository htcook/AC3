...
async function triggerScheduledScan(monitor) {
  ...
  try {
    ...
    const { detectSubdomainTakeover, crossReferenceTechVulnerabilities, detectSubdomainChanges } = await import("./domain-intel-advanced-BZQPZYW6.js");
...
function initScanScheduler() {
  ...
  setTimeout(async () => {
    try {
      const { startPeriodicHealthChecks } = await import("./health-monitor-W3OA35B2.js");
...
function stopScanScheduler() {
  ...
  import("./health-monitor-W3OA35B2.js").then(({ stopPeriodicHealthChecks }) => {

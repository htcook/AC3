...
async function runPostPipelineGraduation(metrics) {
  const { recordScenarioResult, recordTrainingData } = await import("./graduation-lab-bridge-PZRMTENM.js");
  let methodologyBonus = 0;
  let methodologyRationale = "";
  try {
    const { computeMethodologyGraduationBonus } = await import("./methodology-db-persistence-VMK4JXKT.js");

...
async function correlateFindings(engagementId, zapScanId) {
  ...
  let burpFindings = [];
  try {
    const dbModule = await import("./db-65DPEQYH.js");
...
async function getCrossToolCoverage(engagementId) {
  ...
  try {
    const dbModule2 = await import("./db-65DPEQYH.js");

...
var CALDERA_BASE_URL, CALDERA_API_KEY;
var init_caldera_profile_push = __esm({
  "server/lib/caldera-profile-push.ts"() {
    init_env();
    init_db();
    init_schema();
    init_c2_tactical_knowledge();
    CALDERA_BASE_URL = () => ENV.calderaBaseUrl || "";
    CALDERA_API_KEY = () => ENV.calderaApiKey || "";
  }
});

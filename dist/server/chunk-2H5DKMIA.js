  ...
  async getClient() {
    if (!this.clientPromise) {
      this.clientPromise = (async () => {
        const { MsfClient } = await import("./msf-client-G5GID3F7.js");
        ...
        if (ENV.MSF_RPC_HOST) {
          const { MsfClient: MC } = await import("./msf-client-G5GID3F7.js");
          const client = new MC({
...
async function executeGoPhishStep(plan, step) {
  ...
  try {
    const { fetchGophish } = await import("./shared-DS5QKRWM.js");
    let campaignId;

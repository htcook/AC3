...
async function runLabScan(sessionId, targetUrl, scanProfile) {
  ...
  try {
    ...
    try {
      const { executeRawCommandViaQueue } = await import("./job-queue-bridge-FMD5KEVV.js");
    ...
    try {
      const { executeToolViaQueue } = await import("./job-queue-bridge-FMD5KEVV.js");
      let discoveryFlags;
    ...
    const { executeRawCommandViaQueue: execNucleiCmd } = await import("./job-queue-bridge-FMD5KEVV.js");
    try {

...
} from "./chunk-7YD6HFJJ.js";
import "./chunk-6DIIHEZK.js";
import "./chunk-WVL2ZNPQ.js";
import {
  init_llm,
  invokeLLM
...
async function resolveExecutionInsights(techniqueIds) {
  try {
    const { getHistoryForTechnique, calculateTechniqueReliability } = await import("./c2-learning-engine-2E7IADDI.js");
    const insights = [];
...
async function learnNewTTPs(actorNames, ctx) {
  ...
  try {
    const { getExecutionHistory } = await import("./c2-learning-engine-2E7IADDI.js");

...
async function triggerAutoCrawl(scanId, domain) {
  ...
  try {
    ...
    const { discoveredAssets, webCrawlResults, webCrawlJobs, domainIntelScans } = await import("./schema-RDUWS2ES.js");
    ...
    try {
      ...
      const { resolveAndEnrichEntity, calculateFinancialImpact } = await import("./entity-resolver-AE26LEBY.js");
    ...
    try {
      const { listIntegrations, getClientForIntegration, cacheVendorData } = await import("./vendors-M4KIYP4K.js");
      ...
      if (enabledIntegrations.length > 0) {
        ...
        for (const integration of enabledIntegrations) {
          try {
            ...
            const { VENDOR_METADATA } = await import("./vendors-M4KIYP4K.js");

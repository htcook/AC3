...
async function runLabScan(sessionId, targetUrl, scanProfile) {
  ...
  try {
    ...
    try {
      const { executeRawCommandViaQueue } = await import("./job-queue-bridge-TUKZ3QDD.js");
    ...
    try {
      const { executeToolViaQueue } = await import("./job-queue-bridge-TUKZ3QDD.js");
      let discoveryFlags;
    ...
    const { executeRawCommandViaQueue: execNucleiCmd } = await import("./job-queue-bridge-TUKZ3QDD.js");
    try {

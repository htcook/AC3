...
async function runHealthCheckForIntegration(integrationId) {
  const { getCustomerIntegrationByIntegrationId, createHealthCheck, updateCustomerIntegration } = await import("./db-GNA5CL3K.js");
...
async function runAllHealthChecks() {
  try {
    const { getCustomerIntegrationsByStatus } = await import("./db-GNA5CL3K.js");

...
async function runPostPipelineGraduation(metrics) {
  const { recordScenarioResult, recordTrainingData } = await import("./graduation-lab-bridge-JAKODQHS.js");
  let methodologyBonus = 0;
  let methodologyRationale = "";
  try {
    const { computeMethodologyGraduationBonus } = await import("./methodology-db-persistence-IB5GJSSD.js");

...
} from "./chunk-JQSEO5QL.js";
import "./chunk-CWLWEHNO.js";
import "./chunk-FTSYONKO.js";
import {
  init_llm,
  invokeLLM
...
async function resolveExecutionInsights(techniqueIds) {
  try {
    const { getHistoryForTechnique, calculateTechniqueReliability } = await import("./c2-learning-engine-HSZK77QO.js");
    const insights = [];
...
async function learnNewTTPs(actorNames, ctx) {
  ...
  try {
    const { getExecutionHistory } = await import("./c2-learning-engine-HSZK77QO.js");

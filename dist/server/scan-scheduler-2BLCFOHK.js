...
async function triggerScheduledScan(monitor) {
  ...
  try {
    ...
    const { detectSubdomainTakeover, crossReferenceTechVulnerabilities, detectSubdomainChanges } = await import("./domain-intel-advanced-ZRGUB4WJ.js");
...
function initScanScheduler() {
  ...
  setTimeout(async () => {
    try {
      const { startPeriodicHealthChecks } = await import("./health-monitor-GG6CV4ZN.js");
...
function stopScanScheduler() {
  ...
  import("./health-monitor-GG6CV4ZN.js").then(({ stopPeriodicHealthChecks }) => {

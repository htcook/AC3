...
async function enrichFromThreatIntel(hosts) {
  try {
    const { enrichThreatIntelligence } = await import("./bug-bounty-intelligence-I762ND2V.js");
...
async function enrichFromOpSec(hosts) {
  try {
    const { enrichOpSec } = await import("./bug-bounty-intelligence-I762ND2V.js");
...
async function runDiscoveryPipeline(targets, config, onProgress) {
  ...
  try {
    ...
    const { createCarverRiskCardsBatch } = await import("./db-EEYUM2OC.js");

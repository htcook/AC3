...
async function runLabScan(sessionId, targetUrl, scanProfile) {
  ...
  try {
    ...
    try {
      const { executeRawCommandViaQueue } = await import("./job-queue-bridge-CHA7XTTE.js");
    ...
    try {
      const { executeToolViaQueue } = await import("./job-queue-bridge-CHA7XTTE.js");
      let discoveryFlags;
    ...
    const { executeRawCommandViaQueue: execNucleiCmd } = await import("./job-queue-bridge-CHA7XTTE.js");
    try {

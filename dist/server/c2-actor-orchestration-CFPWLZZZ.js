...
} from "./chunk-SYU4TCPQ.js";
import "./chunk-ULMMZUP3.js";
import "./chunk-5HGZAUCV.js";
import {
  init_llm,
  invokeLLM
...
async function resolveExecutionInsights(techniqueIds) {
  try {
    const { getHistoryForTechnique, calculateTechniqueReliability } = await import("./c2-learning-engine-M4IOLQ5A.js");
    const insights = [];
...
async function learnNewTTPs(actorNames, ctx) {
  ...
  try {
    const { getExecutionHistory } = await import("./c2-learning-engine-M4IOLQ5A.js");

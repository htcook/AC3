...
async function generateAutoReport(state, engagement, callbacks) {
  ...
  const { ac3Reports: reportsTable, ac3ReportFindings: findingsTable } = await import("./schema-KTWCH6W6.js");
...
5. Executive narrative (2-3 paragraphs, noting vendor dependency risks separately)`
  ...
  let gapsSummary = "";
  try {
    const { listGaps, formatGapsForReport } = await import("./intelligence-gaps-KMQXXSH4.js");

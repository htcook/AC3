...
// server/lib/knowledge/injection-tools-knowledge.ts
function buildInjectionToolContext() {
  const sections = [];
...
function getInjectionToolForVulnType(vulnType) {
...
var COMMIX_KNOWLEDGE, TPLMAP_KNOWLEDGE, SCREENSHOT_KNOWLEDGE;
var init_injection_tools_knowledge = __esm({
  "server/lib/knowledge/injection-tools-knowledge.ts"() {
    COMMIX_KNOWLEDGE = {
      name: "Commix",
      version: "3.x",
...
init_injection_tools_knowledge();
export {
  COMMIX_KNOWLEDGE,
  SCREENSHOT_KNOWLEDGE,
  TPLMAP_KNOWLEDGE,
  buildInjectionToolContext,
  getInjectionToolForVulnType
};

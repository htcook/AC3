...
async function enrichFromThreatIntel(hosts) {
  try {
    const { enrichThreatIntelligence } = await import("./bug-bounty-intelligence-NRVE7VYK.js");
...
async function enrichFromOpSec(hosts) {
  try {
    const { enrichOpSec } = await import("./bug-bounty-intelligence-NRVE7VYK.js");
...
async function runDiscoveryPipeline(targets, config, onProgress) {
  ...
  try {
    ...
    const { createCarverRiskCardsBatch } = await import("./db-OF4HQS7N.js");

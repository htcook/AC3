...
async function triggerAutoCrawl(scanId, domain) {
  ...
  try {
    ...
    const { discoveredAssets, webCrawlResults, webCrawlJobs, domainIntelScans } = await import("./schema-NFOE7JII.js");
    ...
    try {
      ...
      const { resolveAndEnrichEntity, calculateFinancialImpact } = await import("./entity-resolver-OWI2DH5B.js");
    ...
    try {
      const { listIntegrations, getClientForIntegration, cacheVendorData } = await import("./vendors-EH36Q53A.js");
      ...
      if (enabledIntegrations.length > 0) {
        ...
        for (const integration of enabledIntegrations) {
          try {
            ...
            const { VENDOR_METADATA } = await import("./vendors-EH36Q53A.js");
